    ...
    implements JMLEnumeration<E>, JMLObjectType
{
    ...
    //@ protected represents uniteratedElems <- new JMLObjectSet<E>(currentNode);
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLObjectSetEnumerator(/*@ non_null @*/ JMLObjectSet<E> s) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectSetEnumerator<E>(new JMLObjectSet<E>(currentNode));
    } //@ nowarn Post;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLObjectSetEnumerator)) {
            ...
            JMLObjectSetEnumerator<E> js = (JMLObjectSetEnumerator<E>) oth;
            if (currentNode == null) {
