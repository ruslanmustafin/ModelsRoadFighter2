 ...
 */
//-@ immutable
public /*@ pure @*/ class JMLEqualsToValueRelation<K, V extends JMLType>
    implements JMLCollection<JMLEqualsValuePair<K, V>> {

    /** The set of pairs of keys and values conceptually contained in
     * this object.
     */
    //@ public model JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>> theRelation;
    /*@ public invariant
     ...
     */
    protected final /*@ non_null @*/ JMLEqualsSet<K> domain_;
    //@                                             in theRelation;
     ...
     */
    protected final /*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> imagePairSet_;
    //@                                             in theRelation;
    ...
    /*@  public normal_behavior
      ...
      @    ensures theRelation.equals(new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>());
    ...
    public JMLEqualsToValueRelation()
    {
        ...
        imagePairSet_ = new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>();
        size_ = 0;
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLEqualsToValueRelation(/*@ non_null @*/ K dv,
                                        /*@ non_null @*/ V rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
        ...
        imagePairSet_ = new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>(new JMLEqualsValuePair<K, JMLValueSet<V>>(dv, img));
    }

    /** Initialize this to be a relation containing a single association
     *  given by the pair.
     * @see #singleton(JMLEqualsValuePair)
     * @see #JMLEqualsToValueRelation(K, V)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLEqualsToValueRelation(/*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> ipset, 
                                     /*@ non_null @*/ JMLEqualsSet<K> dom, 
                                     int sz)
    {
        //@ set owner = null;
        //@ set containsNull = false;
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToValueRelation<SK, SR>(dv, rv));
      @*/
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToValueRelation<SK, SR>
        singleton(/*@ non_null @*/ SK dv,
                  /*@ non_null @*/ SR rv) {
        return new JMLEqualsToValueRelation<SK, SR>(dv, rv);
    }
    ...
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToValueRelation<SK, SR>
        singleton(/*@ non_null @*/ JMLEqualsValuePair<SK, SR> pair)
    {
    ...
    {
        JMLEqualsToValueRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
        JMLEqualsValuePair<K, JMLValueSet<V>> imagePair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet<V> image(/*@ non_null @*/ JMLEqualsSet<K> dom)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueToEqualsRelation<V, K> inverse()
    {
        JMLValueToEqualsRelation<V, K> invRel
            = new JMLValueToEqualsRelation<V, K>();
        JMLEqualsToValueRelationEnumerator<K, V> assocEnum = this.associations();
        JMLEqualsValuePair<K, V> pair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet<K> inverseElementImage(V rv)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet<K> inverseImage(/*@ non_null @*/ JMLValueSet<V> rng)
    {
        JMLEqualsSet<K> invImg = new JMLEqualsSet<K>();
        JMLEqualsToValueRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLEqualsValuePair<K, V> pair)
    {
    ...
    /*@ also
      ...
      @              obj != null
      @           && obj instanceof JMLEqualsValuePair
      @           && has((JMLEqualsValuePair<K, V>) obj);
      @*/
    ...
    {
        return new
            JMLEqualsToValueRelation<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        ...
        JMLEqualsToValueRelation<K, V> rel
            = (JMLEqualsToValueRelation<K, V>) obj;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsSet<K> domain()
    {
        return domain_;
    }
    ...
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLEqualsToValueRelation<K, V> add(/*@ non_null @*/ K dv,
                                         /*@ non_null @*/ V rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> newImagePairSet;
        ...
        if (!domain_.has(dv)) {
            ...
            newImagePairSet
                = imagePairSet_.insert(new JMLEqualsValuePair<K, JMLValueSet<V>>(dv, img));
        } else {
            newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>();
            newDom = domain_;
            newSize = 0;
            ...
            while (imagePairEnum.hasMoreElements()) {
                ...
                newImagePairSet 
                    = newImagePairSet
                    .insert(new JMLEqualsValuePair<K, JMLValueSet<V>>(imagePair.key, img));
            }
        }
        return new JMLEqualsToValueRelation<K, V>(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToValueRelation<K, V> insert(/*@ non_null @*/
                                         JMLEqualsValuePair<K, V> pair)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToValueRelation<K, V> removeFromDomain(/*@ nullable @*/ K dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> newImagePairSet
				= new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToValueRelation<K, V> remove(K dv, V rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>();
        ...
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imagePair.keyEquals(dv)) {
                ...
                if (imgSize > 0) {
                    newImagePairSet
                        = newImagePairSet
                        .insert(new JMLEqualsValuePair<K, JMLValueSet<V>>(dv, img));
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToValueRelation<K, V> remove(/*@ non_null @*/
                                            JMLEqualsValuePair<K, V> pair)
    {
    ...
    public /*@ non_null @*/ <D extends JMLType>
        ...
        compose(/*@ non_null @*/ JMLValueToEqualsRelation<D, K> othRel)
    {
        ...
        JMLValueToEqualsRelationImageEnumerator<D, K> imagePairEnum
            = othRel.imagePairs();
    ...
    public /*@ non_null @*/ <D>
        ...
        compose(/*@ non_null @*/ JMLObjectToEqualsRelation<D, K> othRel)
    {
        ...
        JMLObjectToEqualsRelationImageEnumerator<D, K> imagePairEnum
            = othRel.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToValueRelation<K, V> 
        union(/*@ non_null @*/ JMLEqualsToValueRelation<K, V> othRel)
        throws IllegalStateException
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>();
        JMLEqualsSet<K> newDom = domain_;
        ...
        return new JMLEqualsToValueRelation<K, V>(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLEqualsToValueRelation<K, V>
        intersection(/*@ non_null @*/ JMLEqualsToValueRelation<K, V> othRel)
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>();
    ...
    public /*@ non_null @*/  
        JMLEqualsToValueRelation<K, V>
        difference(/*@ non_null @*/ JMLEqualsToValueRelation<K, V> othRel)
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>();
        JMLEqualsSet<K> newDom = new JMLEqualsSet<K>();
        int newSize = 0;
    ...
    public /*@ non_null @*/ 
        JMLEqualsToValueRelation<K, V> 
        restrictDomainTo(/*@ non_null @*/ JMLEqualsSet<K> dom)
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToValueRelationEnumerator<K, V> associations()
    {
        return new JMLEqualsToValueRelationEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToValueRelationEnumerator<K, V> elements()
    {
        return associations();
    }
    ...
    public JMLIterator<JMLEqualsValuePair<K, V>> iterator() {
        return new JMLEnumerationToIterator<JMLEqualsValuePair<K, V>>(elements());
    }  //@ nowarn Post;
    ...
    /*@ public normal_behavior
      ...
      @             
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, V>> toSet() {
        JMLEqualsToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSet<JMLEqualsValuePair<K, V>> ret = new JMLValueSet<JMLEqualsValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLEqualsValuePair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
        }
        return ret;
    } //@ nowarn Exception;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueBag<JMLEqualsValuePair<K, V>> toBag() {
        JMLEqualsToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueBag<JMLEqualsValuePair<K, V>> ret = new JMLValueBag<JMLEqualsValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLEqualsValuePair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSequence<JMLEqualsValuePair<K, V>> toSequence() {
        JMLEqualsToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSequence<JMLEqualsValuePair<K, V>> ret = new JMLValueSequence<JMLEqualsValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLEqualsValuePair<K, V> p = pairEnum.nextPair();
    ...
    /*@ public normal_behavior
      ...
      @                \result.has(
      @                    new JMLEqualsValuePair<K, JMLValueSet<V>>(dv, elementImage(dv))));
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> imagePairSet() {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToValueRelationImageEnumerator<K, V> imagePairs() {
        return new JMLEqualsToValueRelationImageEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsToValueMap<K, V> toFunction()
    {
        JMLEqualsSet<K> newDom = domain_;
        int newSize = domain_.int_size();

        JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> newImagePairSet = imagePairSet_;
        ...
        return new JMLEqualsToValueMap<K, V>(newImagePairSet, newDom, newSize);
    } //@ nowarn Exception;
}
