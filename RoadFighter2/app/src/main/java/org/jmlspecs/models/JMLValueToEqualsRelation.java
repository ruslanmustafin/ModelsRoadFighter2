 ...
 */
//-@ immutable
public /*@ pure @*/ class JMLValueToEqualsRelation<K extends JMLType, V>
    implements JMLCollection<JMLValueEqualsPair<K, V>> {

    /** The set of pairs of keys and values conceptually contained in
     * this object.
     */
    //@ public model JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>> theRelation;
    /*@ public invariant
     ...
     */
    protected final /*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> imagePairSet_;
    //@                                             in theRelation;
    ...
    /*@  public normal_behavior
      ...
      @    ensures theRelation.equals(new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>());
    ...
    public JMLValueToEqualsRelation()
    {
        ...
        imagePairSet_ = new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>();
        size_ = 0;
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLValueToEqualsRelation(/*@ non_null @*/ K dv,
                                        /*@ non_null @*/ V rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
        ...
        imagePairSet_ = new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>(new JMLValueValuePair<K, JMLEqualsSet<V>>(dv, img));
    }

    /** Initialize this to be a relation containing a single association
     *  given by the pair.
     * @see #singleton(JMLValueEqualsPair)
     * @see #JMLValueToEqualsRelation(K, V)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLValueToEqualsRelation(/*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> ipset, 
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLValueToEqualsRelation<SK, SR>(dv, rv));
      @*/
    public static <SK extends JMLType, SR> /*@ pure @*/ /*@ non_null @*/
        JMLValueToEqualsRelation<SK, SR>
        singleton(/*@ non_null @*/ SK dv,
                  /*@ non_null @*/ SR rv) {
        return new JMLValueToEqualsRelation<SK, SR>(dv, rv);
    }
    ...
    public static <SK extends JMLType, SR> /*@ pure @*/ /*@ non_null @*/
        JMLValueToEqualsRelation<SK, SR>
        singleton(/*@ non_null @*/ JMLValueEqualsPair<SK, SR> pair)
    {
        ...
        JMLEqualsSet<V> elementImage(/*@ nullable @*/ K dv)
    {
        JMLValueToEqualsRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
        JMLValueValuePair<K, JMLEqualsSet<V>> imagePair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet<V> image(/*@ non_null @*/ JMLValueSet<K> dom)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsToValueRelation<V, K> inverse()
    {
        JMLEqualsToValueRelation<V, K> invRel
            = new JMLEqualsToValueRelation<V, K>();
        JMLValueToEqualsRelationEnumerator<K, V> assocEnum = this.associations();
        JMLValueEqualsPair<K, V> pair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet<K> inverseImage(/*@ non_null @*/ JMLEqualsSet<V> rng)
    {
        JMLValueSet<K> invImg = new JMLValueSet<K>();
        JMLValueToEqualsRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLValueEqualsPair<K, V> pair)
    {
    ...
    /*@ also
      ...
      @              obj != null
      @           && obj instanceof JMLValueEqualsPair
      @           && has((JMLValueEqualsPair<K, V>) obj);
      @*/
    ...
    {
        return new
            JMLValueToEqualsRelation<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        ...
        JMLValueToEqualsRelation<K, V> rel
            = (JMLValueToEqualsRelation<K, V>) obj;
    ...
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLValueToEqualsRelation<K, V> add(/*@ non_null @*/ K dv,
                                         /*@ non_null @*/ V rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> newImagePairSet;
        ...
        if (!domain_.has(dv)) {
            ...
            newImagePairSet
                = imagePairSet_.insert(new JMLValueValuePair<K, JMLEqualsSet<V>>(dv, img));
        } else {
            newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>();
            newDom = domain_;
            newSize = 0;
            ...
            while (imagePairEnum.hasMoreElements()) {
                ...
                newImagePairSet 
                    = newImagePairSet
                    .insert(new JMLValueValuePair<K, JMLEqualsSet<V>>(imagePair.key, img));
            }
        }
        return new JMLValueToEqualsRelation<K, V>(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToEqualsRelation<K, V> insert(/*@ non_null @*/
                                         JMLValueEqualsPair<K, V> pair)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToEqualsRelation<K, V> removeFromDomain(/*@ nullable @*/ K dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> newImagePairSet
				= new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToEqualsRelation<K, V> remove(K dv, V rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>();
        ...
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imagePair.keyEquals(dv)) {
                ...
                if (imgSize > 0) {
                    newImagePairSet
                        = newImagePairSet
                        .insert(new JMLValueValuePair<K, JMLEqualsSet<V>>(dv, img));
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToEqualsRelation<K, V> remove(/*@ non_null @*/
                                            JMLValueEqualsPair<K, V> pair)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToEqualsRelation<K, V> 
        union(/*@ non_null @*/ JMLValueToEqualsRelation<K, V> othRel)
        throws IllegalStateException
    {
        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>();
        JMLValueSet<K> newDom = domain_;
        ...
        return new JMLValueToEqualsRelation<K, V>(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLValueToEqualsRelation<K, V>
        intersection(/*@ non_null @*/ JMLValueToEqualsRelation<K, V> othRel)
    {
        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>();
    ...
    public /*@ non_null @*/  
        JMLValueToEqualsRelation<K, V>
        difference(/*@ non_null @*/ JMLValueToEqualsRelation<K, V> othRel)
    {
        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>();
        JMLValueSet<K> newDom = new JMLValueSet<K>();
        int newSize = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToEqualsRelationEnumerator<K, V> associations()
    {
        return new JMLValueToEqualsRelationEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToEqualsRelationEnumerator<K, V> elements()
    {
        return associations();
    }
    ...
    /*@ also
      ...
      @*/  
    public JMLIterator<JMLValueEqualsPair<K, V>> iterator() {
        return new JMLEnumerationToIterator<JMLValueEqualsPair<K, V>>(elements());
    }  //@ nowarn Post;
    ...
    /*@ public normal_behavior
      ...
      @             
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLValueEqualsPair<K, V>> toSet() {
        JMLValueToEqualsRelationEnumerator<K, V> pairEnum = this.associations();
        ...
        while (pairEnum.hasMoreElements()) {
            ...
            JMLValueEqualsPair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
        }
        return ret;
    } //@ nowarn Exception;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueBag<JMLValueEqualsPair<K, V>> toBag() {
        JMLValueToEqualsRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueBag<JMLValueEqualsPair<K, V>> ret = new JMLValueBag<JMLValueEqualsPair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLValueEqualsPair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSequence<JMLValueEqualsPair<K, V>> toSequence() {
        JMLValueToEqualsRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSequence<JMLValueEqualsPair<K, V>> ret = new JMLValueSequence<JMLValueEqualsPair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLValueEqualsPair<K, V> p = pairEnum.nextPair();
    ...
    /*@ public normal_behavior
      ...
      @                \result.has(
      @                    new JMLValueValuePair<K, JMLEqualsSet<V>>(dv, elementImage(dv))));
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> imagePairSet() {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToEqualsRelationImageEnumerator<K, V> imagePairs() {
        return new JMLValueToEqualsRelationImageEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueToEqualsMap<K, V> toFunction()
    {
        JMLValueSet<K> newDom = domain_;
        int newSize = domain_.int_size();

        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> newImagePairSet = imagePairSet_;
        ...
        return new JMLValueToEqualsMap<K, V>(newImagePairSet, newDom, newSize);
    } //@ nowarn Exception;
}
