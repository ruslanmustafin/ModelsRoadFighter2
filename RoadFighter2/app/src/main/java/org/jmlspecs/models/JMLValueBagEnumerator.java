...
/*@ nullable_by_default @*/ 
public class JMLValueBagEnumerator<E extends JMLType>
    implements JMLEnumeration<E>, JMLValueType
{
    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLValueBag<E> uniteratedElems;   in objectState;

    /** The bag underlying this enumerator.
     */
    protected /*@ non_null @*/ JMLValueBag<E> currentBag;
    //@                                        in uniteratedElems;
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLValueBagEnumerator(/*@ non_null @*/ JMLValueBag<E> b) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLValueBagEnumerator<E>(abstractValue());
    } //@ nowarn Post;

    /** Return the abstract value of this bag enumerator.
     */
    protected /*@ pure non_null @*/ JMLValueBag<E> abstractValue() {
        JMLValueBag<E> absVal = currentBag;
        if (currentCount > 0) {
