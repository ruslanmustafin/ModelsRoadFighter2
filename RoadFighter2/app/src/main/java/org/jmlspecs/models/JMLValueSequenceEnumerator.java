...
/*@ nullable_by_default @*/ 
public class JMLValueSequenceEnumerator<E extends JMLType>
    implements JMLEnumeration<E>, JMLValueType
{

    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLValueSequence<E> uniteratedElems; in objectState;
    ...
    /*@ protected represents uniteratedElems
      @                  <- new JMLValueSequence<E>(currentNode, remaining);
      @*/
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLValueSequenceEnumerator(/*@ non_null @*/ JMLValueSequence<E> s) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return
            new JMLValueSequenceEnumerator<E>(new JMLValueSequence<E>(currentNode,
                                                                  remaining));
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLValueSequenceEnumerator)) {
            return false;
        } else {
            JMLValueSequenceEnumerator<E> js
                = (JMLValueSequenceEnumerator<E>) oth;
            if (currentNode == null) {
