 ...
 */
//-@ immutable
public /*@ pure @*/ class JMLEqualsToObjectRelation<K, V>
    implements JMLCollection<JMLEqualsObjectPair<K, V>> {

    /** The set of pairs of keys and values conceptually contained in
     * this object.
     */
    //@ public model JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>> theRelation;
    /*@ public invariant
     ...
     */
    protected final /*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> imagePairSet_;
    //@                                             in theRelation;
    ...
    /*@  public normal_behavior
      ...
      @    ensures theRelation.equals(new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>());
    ...
    public JMLEqualsToObjectRelation()
    {
        ...
        imagePairSet_ = new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>();
        size_ = 0;
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLEqualsToObjectRelation(/*@ non_null @*/ K dv,
                                        /*@ non_null @*/ V rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
        ...
        imagePairSet_ = new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>(new JMLEqualsValuePair<K, JMLObjectSet<V>>(dv, img));
    }

    /** Initialize this to be a relation containing a single association
     *  given by the pair.
     * @see #singleton(JMLEqualsObjectPair)
     * @see #JMLEqualsToObjectRelation(K, V)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLEqualsToObjectRelation(/*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> ipset, 
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToObjectRelation<SK, SR>(dv, rv));
      @*/
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToObjectRelation<SK, SR>
        singleton(/*@ non_null @*/ SK dv,
                  /*@ non_null @*/ SR rv) {
        return new JMLEqualsToObjectRelation<SK, SR>(dv, rv);
    }
    ...
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToObjectRelation<SK, SR>
        singleton(/*@ non_null @*/ JMLEqualsObjectPair<SK, SR> pair)
    {
    ...
    {
        JMLEqualsToObjectRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
        JMLEqualsValuePair<K, JMLObjectSet<V>> imagePair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectSet<V> image(/*@ non_null @*/ JMLEqualsSet<K> dom)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLObjectToEqualsRelation<V, K> inverse()
    {
        JMLObjectToEqualsRelation<V, K> invRel
            = new JMLObjectToEqualsRelation<V, K>();
        JMLEqualsToObjectRelationEnumerator<K, V> assocEnum = this.associations();
        JMLEqualsObjectPair<K, V> pair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet<K> inverseImage(/*@ non_null @*/ JMLObjectSet<V> rng)
    {
        JMLEqualsSet<K> invImg = new JMLEqualsSet<K>();
        JMLEqualsToObjectRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLEqualsObjectPair<K, V> pair)
    {
    ...
    /*@ also
      ...
      @              obj != null
      @           && obj instanceof JMLEqualsObjectPair
      @           && has((JMLEqualsObjectPair<K, V>) obj);
      @*/
    ...
    {
        return new
            JMLEqualsToObjectRelation<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        ...
        JMLEqualsToObjectRelation<K, V> rel
            = (JMLEqualsToObjectRelation<K, V>) obj;
    ...
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLEqualsToObjectRelation<K, V> add(/*@ non_null @*/ K dv,
                                         /*@ non_null @*/ V rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> newImagePairSet;
        ...
        if (!domain_.has(dv)) {
            ...
            newImagePairSet
                = imagePairSet_.insert(new JMLEqualsValuePair<K, JMLObjectSet<V>>(dv, img));
        } else {
            newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>();
            newDom = domain_;
            newSize = 0;
            ...
            while (imagePairEnum.hasMoreElements()) {
                ...
                newImagePairSet 
                    = newImagePairSet
                    .insert(new JMLEqualsValuePair<K, JMLObjectSet<V>>(imagePair.key, img));
            }
        }
        return new JMLEqualsToObjectRelation<K, V>(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToObjectRelation<K, V> insert(/*@ non_null @*/
                                         JMLEqualsObjectPair<K, V> pair)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToObjectRelation<K, V> removeFromDomain(/*@ nullable @*/ K dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> newImagePairSet
				= new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToObjectRelation<K, V> remove(K dv, V rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>();
        ...
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imagePair.keyEquals(dv)) {
                ...
                if (imgSize > 0) {
                    newImagePairSet
                        = newImagePairSet
                        .insert(new JMLEqualsValuePair<K, JMLObjectSet<V>>(dv, img));
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToObjectRelation<K, V> remove(/*@ non_null @*/
                                            JMLEqualsObjectPair<K, V> pair)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToObjectRelation<K, V> 
        union(/*@ non_null @*/ JMLEqualsToObjectRelation<K, V> othRel)
        throws IllegalStateException
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>();
        JMLEqualsSet<K> newDom = domain_;
        ...
        return new JMLEqualsToObjectRelation<K, V>(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLEqualsToObjectRelation<K, V>
        intersection(/*@ non_null @*/ JMLEqualsToObjectRelation<K, V> othRel)
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>();
    ...
    public /*@ non_null @*/  
        JMLEqualsToObjectRelation<K, V>
        difference(/*@ non_null @*/ JMLEqualsToObjectRelation<K, V> othRel)
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>();
        JMLEqualsSet<K> newDom = new JMLEqualsSet<K>();
        int newSize = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToObjectRelationEnumerator<K, V> associations()
    {
        return new JMLEqualsToObjectRelationEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToObjectRelationEnumerator<K, V> elements()
    {
        return associations();
    }
    ...
    /*@ also
      ...
      @*/  
    public JMLIterator<JMLEqualsObjectPair<K, V>> iterator() {
        return new JMLEnumerationToIterator<JMLEqualsObjectPair<K, V>>(elements());
    }  //@ nowarn Post;
    ...
    /*@ public normal_behavior
      ...
      @             
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLEqualsObjectPair<K, V>> toSet() {
        JMLEqualsToObjectRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSet<JMLEqualsObjectPair<K, V>> ret = new JMLValueSet<JMLEqualsObjectPair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLEqualsObjectPair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
        }
        return ret;
    } //@ nowarn Exception;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueBag<JMLEqualsObjectPair<K, V>> toBag() {
        JMLEqualsToObjectRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueBag<JMLEqualsObjectPair<K, V>> ret = new JMLValueBag<JMLEqualsObjectPair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLEqualsObjectPair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSequence<JMLEqualsObjectPair<K, V>> toSequence() {
        JMLEqualsToObjectRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSequence<JMLEqualsObjectPair<K, V>> ret = new JMLValueSequence<JMLEqualsObjectPair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLEqualsObjectPair<K, V> p = pairEnum.nextPair();
    ...
    /*@ public normal_behavior
      ...
      @                \result.has(
      @                    new JMLEqualsValuePair<K, JMLObjectSet<V>>(dv, elementImage(dv))));
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> imagePairSet() {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToObjectRelationImageEnumerator<K, V> imagePairs() {
        return new JMLEqualsToObjectRelationImageEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsToObjectMap<K, V> toFunction()
    {
        JMLEqualsSet<K> newDom = domain_;
        int newSize = domain_.int_size();

        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> newImagePairSet = imagePairSet_;
        ...
        return new JMLEqualsToObjectMap<K, V>(newImagePairSet, newDom, newSize);
    } //@ nowarn Exception;
}
