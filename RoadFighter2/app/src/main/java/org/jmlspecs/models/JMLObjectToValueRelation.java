 ...
 */
//-@ immutable
public /*@ pure @*/ class JMLObjectToValueRelation<K, V extends JMLType>
    implements JMLCollection<JMLObjectValuePair<K, V>> {

    /** The set of pairs of keys and values conceptually contained in
     * this object.
     */
    //@ public model JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>> theRelation;
    /*@ public invariant
     ...
     */
    protected final /*@ non_null @*/ JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> imagePairSet_;
    //@                                             in theRelation;
    ...
    /*@  public normal_behavior
      ...
      @    ensures theRelation.equals(new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>());
    ...
    public JMLObjectToValueRelation()
    {
        ...
        imagePairSet_ = new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>();
        size_ = 0;
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLObjectToValueRelation(/*@ non_null @*/ K dv,
                                        /*@ non_null @*/ V rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
        ...
        imagePairSet_ = new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>(new JMLObjectValuePair<K, JMLValueSet<V>>(dv, img));
    }

    /** Initialize this to be a relation containing a single association
     *  given by the pair.
     * @see #singleton(JMLObjectValuePair)
     * @see #JMLObjectToValueRelation(K, V)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLObjectToValueRelation(/*@ non_null @*/ JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> ipset, 
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLObjectToValueRelation<SK, SR>(dv, rv));
      @*/
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLObjectToValueRelation<SK, SR>
        singleton(/*@ non_null @*/ SK dv,
                  /*@ non_null @*/ SR rv) {
        return new JMLObjectToValueRelation<SK, SR>(dv, rv);
    }
    ...
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLObjectToValueRelation<SK, SR>
        singleton(/*@ non_null @*/ JMLObjectValuePair<SK, SR> pair)
    {
    ...
    {
        JMLObjectToValueRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
        JMLObjectValuePair<K, JMLValueSet<V>> imagePair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet<V> image(/*@ non_null @*/ JMLObjectSet<K> dom)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueToObjectRelation<V, K> inverse()
    {
        JMLValueToObjectRelation<V, K> invRel
            = new JMLValueToObjectRelation<V, K>();
        JMLObjectToValueRelationEnumerator<K, V> assocEnum = this.associations();
        JMLObjectValuePair<K, V> pair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectSet<K> inverseImage(/*@ non_null @*/ JMLValueSet<V> rng)
    {
        JMLObjectSet<K> invImg = new JMLObjectSet<K>();
        JMLObjectToValueRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLObjectValuePair<K, V> pair)
    {
    ...
    /*@ also
      ...
      @              obj != null
      @           && obj instanceof JMLObjectValuePair
      @           && has((JMLObjectValuePair<K, V>) obj);
      @*/
    ...
    {
        return new
            JMLObjectToValueRelation<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        ...
        JMLObjectToValueRelation<K, V> rel
            = (JMLObjectToValueRelation<K, V>) obj;
    ...
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLObjectToValueRelation<K, V> add(/*@ non_null @*/ K dv,
                                         /*@ non_null @*/ V rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> newImagePairSet;
        ...
        if (!domain_.has(dv)) {
            ...
            newImagePairSet
                = imagePairSet_.insert(new JMLObjectValuePair<K, JMLValueSet<V>>(dv, img));
        } else {
            newImagePairSet = new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>();
            newDom = domain_;
            newSize = 0;
            ...
            while (imagePairEnum.hasMoreElements()) {
                ...
                newImagePairSet 
                    = newImagePairSet
                    .insert(new JMLObjectValuePair<K, JMLValueSet<V>>(imagePair.key, img));
            }
        }
        return new JMLObjectToValueRelation<K, V>(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLObjectToValueRelation<K, V> insert(/*@ non_null @*/
                                         JMLObjectValuePair<K, V> pair)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLObjectToValueRelation<K, V> removeFromDomain(/*@ nullable @*/ K dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> newImagePairSet
				= new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLObjectToValueRelation<K, V> remove(K dv, V rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>();
        ...
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imagePair.keyEquals(dv)) {
                ...
                if (imgSize > 0) {
                    newImagePairSet
                        = newImagePairSet
                        .insert(new JMLObjectValuePair<K, JMLValueSet<V>>(dv, img));
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLObjectToValueRelation<K, V> remove(/*@ non_null @*/
                                            JMLObjectValuePair<K, V> pair)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLObjectToValueRelation<K, V> 
        union(/*@ non_null @*/ JMLObjectToValueRelation<K, V> othRel)
        throws IllegalStateException
    {
        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>();
        JMLObjectSet<K> newDom = domain_;
        ...
        return new JMLObjectToValueRelation<K, V>(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLObjectToValueRelation<K, V>
        intersection(/*@ non_null @*/ JMLObjectToValueRelation<K, V> othRel)
    {
        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>();
    ...
    public /*@ non_null @*/  
        JMLObjectToValueRelation<K, V>
        difference(/*@ non_null @*/ JMLObjectToValueRelation<K, V> othRel)
    {
        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>();
        JMLObjectSet<K> newDom = new JMLObjectSet<K>();
        int newSize = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectToValueRelationEnumerator<K, V> associations()
    {
        return new JMLObjectToValueRelationEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectToValueRelationEnumerator<K, V> elements()
    {
        return associations();
    }
    ...
    /*@ also
      ...
      @*/  
    public JMLIterator<JMLObjectValuePair<K, V>> iterator() {
        return new JMLEnumerationToIterator<JMLObjectValuePair<K, V>>(elements());
    }  //@ nowarn Post;
    ...
    /*@ public normal_behavior
      ...
      @             
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLObjectValuePair<K, V>> toSet() {
        JMLObjectToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSet<JMLObjectValuePair<K, V>> ret = new JMLValueSet<JMLObjectValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLObjectValuePair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
        }
        return ret;
    } //@ nowarn Exception;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueBag<JMLObjectValuePair<K, V>> toBag() {
        JMLObjectToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueBag<JMLObjectValuePair<K, V>> ret = new JMLValueBag<JMLObjectValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLObjectValuePair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSequence<JMLObjectValuePair<K, V>> toSequence() {
        JMLObjectToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSequence<JMLObjectValuePair<K, V>> ret = new JMLValueSequence<JMLObjectValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLObjectValuePair<K, V> p = pairEnum.nextPair();
    ...
    /*@ public normal_behavior
      ...
      @                \result.has(
      @                    new JMLObjectValuePair<K, JMLValueSet<V>>(dv, elementImage(dv))));
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> imagePairSet() {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectToValueRelationImageEnumerator<K, V> imagePairs() {
        return new JMLObjectToValueRelationImageEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLObjectToValueMap<K, V> toFunction()
    {
        JMLObjectSet<K> newDom = domain_;
        int newSize = domain_.int_size();

        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> newImagePairSet = imagePairSet_;
        ...
        return new JMLObjectToValueMap<K, V>(newImagePairSet, newDom, newSize);
    } //@ nowarn Exception;
}
