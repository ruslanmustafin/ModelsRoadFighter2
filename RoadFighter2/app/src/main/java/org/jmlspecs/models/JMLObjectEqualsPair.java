...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLObjectEqualsPair<K, V> implements JMLType {
     ...
     */
    public /*@ extract @*/ JMLObjectEqualsPair(/*@ non_null @*/ K dv,
                               /*@ non_null @*/ V rv)
    ...
    {
        return new JMLObjectEqualsPair<K, V>(key, value);
    } //@ nowarn Post;
