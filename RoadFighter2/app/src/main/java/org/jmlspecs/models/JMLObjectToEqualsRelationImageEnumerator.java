...
/*@ nullable_by_default @*/ 
public class JMLObjectToEqualsRelationImageEnumerator<K, V>
    implements JMLEnumeration<JMLObjectValuePair<K, JMLEqualsSet<V>>>, JMLValueType {

    //@ public model JMLValueSet<JMLObjectValuePair<K, JMLEqualsSet<V>>> uniteratedImagePairs;     in objectState;

    /** An enumerator for the image pairs in this relation.
     */
    protected /*@ non_null @*/ JMLValueSetEnumerator<JMLObjectValuePair<K, JMLEqualsSet<V>>> pairEnum;
    ...
    //@ public invariant elementType == \type(JMLObjectValuePair<K, JMLEqualsSet<V>>);
    ...
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLObjectValuePair<K, JMLEqualsSet<V>>);
    ...
    protected
        JMLObjectToEqualsRelationImageEnumerator(/*@ non_null @*/
                                                   JMLValueSetEnumerator<JMLObjectValuePair<K, JMLEqualsSet<V>>> pEnum)
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLObjectValuePair);
        //@ set returnsNull = false;
        pairEnum =  (JMLValueSetEnumerator<JMLObjectValuePair<K, JMLEqualsSet<V>>>)pEnum.clone();
    }
    ...
    /*@ also
      ...
      @*/
    public JMLObjectValuePair<K, JMLEqualsSet<V>> nextElement() throws JMLNoSuchElementException {
        if (pairEnum.hasMoreElements()) {
            JMLObjectValuePair<K, JMLEqualsSet<V>> o = pairEnum.nextElement();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLObjectValuePair<K, JMLEqualsSet<V>> nextImagePair()
        throws JMLNoSuchElementException {
        //@ assume moreElements;
        JMLObjectValuePair<K, JMLEqualsSet<V>> p = nextElement();
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectToEqualsRelationImageEnumerator<K, V>(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLObjectToEqualsRelationImageEnumerator<K, V> js
                = (JMLObjectToEqualsRelationImageEnumerator<K, V>) oth;
    ...
    protected /*@ spec_public pure @*/ /*@ non_null @*/
        JMLValueSet<JMLObjectValuePair<K, JMLEqualsSet<V>>> abstractValue()
    {
        JMLValueSet<JMLObjectValuePair<K, JMLEqualsSet<V>>> ret = new JMLValueSet<JMLObjectValuePair<K, JMLEqualsSet<V>>>();
        JMLObjectToEqualsRelationImageEnumerator<K, V> enum2
            = (JMLObjectToEqualsRelationImageEnumerator<K, V>) clone();
        while (enum2.hasMoreElements()) {
            JMLObjectValuePair<K, JMLEqualsSet<V>> aPair = enum2.nextImagePair();
