...
/*@ nullable_by_default @*/ 
class JMLEqualsToEqualsMap<K, V> extends JMLEqualsToEqualsRelation<K, V> {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLEqualsToEqualsMap(/*@ non_null @*/ K dv,
                                   /*@ non_null @*/ V rv)
    {
        super(dv, rv);
    }
    ...
    protected JMLEqualsToEqualsMap(JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> ipset,
                                      JMLEqualsSet<K> dom,
                                      int sz)
    {
        super(ipset, dom, sz);
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToEqualsMap<K, V>(dv, rv));
      @*/
    public static <SK, SR> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToEqualsMap<SK, SR>
        singletonMap(/*@ non_null @*/ SK dv,
                     /*@ non_null @*/ SR rv)
    {
        return new JMLEqualsToEqualsMap<SK, SR>(dv, rv);
    }
    ...
    public static <SK, SR> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToEqualsMap<SK, SR>
        singletonMap(/*@ non_null @*/ JMLEqualsEqualsPair<SK, SR> pair)
    {
        return new JMLEqualsToEqualsMap<SK, SR>(pair);
    }
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLEqualsToEqualsMap<K, V>
      @          && ((JMLEqualsToEqualsMap<K, V>)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLEqualsToEqualsMap<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
     ...
     * @see JMLEqualsToEqualsRelation#insert(K, V)
     */
    /*@  public normal_behavior
      @    requires dv != null && rv != null;
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToEqualsMap<K, V> extend(/*@ non_null @*/ K dv,
                                       /*@ non_null @*/ V rv) 
    {
        JMLEqualsToEqualsMap<K, V> newMap = this.removeDomainElement(dv);
        newMap = newMap.disjointUnion(new JMLEqualsToEqualsMap<K, V>(dv, rv));
        return newMap;
    } //@ nowarn Exception;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToEqualsMap<K, V> removeDomainElement(K dv)
    {
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsMap<K, V>
        extendUnion(/*@ non_null @*/ JMLEqualsToEqualsMap<K, V> othMap) 
        throws IllegalStateException
    {
        JMLEqualsToEqualsMap<K, V> newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLEqualsToEqualsMap<K, V>(newMap.imagePairSet_
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsMap<K, V>
        clashReplaceUnion(JMLEqualsToEqualsMap<K, V> othMap,
                          V errval)
        throws IllegalStateException
    {
        ...
        JMLEqualsToEqualsRelation<K, V> newRel;
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLEqualsToEqualsRelation<K, V>(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsMap<K, V> 
        disjointUnion(/*@ non_null @*/ JMLEqualsToEqualsMap<K, V> othMap) 
        throws JMLMapException, IllegalStateException
    {
        ...
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLEqualsToEqualsMap<K, V>(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
