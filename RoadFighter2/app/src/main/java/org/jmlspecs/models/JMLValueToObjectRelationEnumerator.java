...
/*@ nullable_by_default @*/ 
public class JMLValueToObjectRelationEnumerator<K extends JMLType, V>
    implements JMLEnumeration<JMLValueObjectPair<K, V>>, JMLValueType {

    //@ public model JMLValueSet<JMLValueObjectPair<K, V>> uniteratedPairs;      in objectState;
    ...
    //@ public invariant elementType == \type(JMLValueObjectPair<K, V>);
    ...
    JMLValueToObjectRelationEnumerator(/*@ non_null @*/
        ...
        //@ set owner = null;
        //@ set elementType = \type(JMLValueObjectPair<K, V>);
        //@ set returnsNull = false;
        imagePairEnum = rel.imagePairs();
        if (imagePairEnum.hasMoreElements()) {
            JMLValueValuePair<K, JMLObjectSet<V>> p = imagePairEnum.nextImagePair();
            key = p.key;
            //@ assume key != null;
            //@ assume p.value != null;
    ...
    protected
        JMLValueToObjectRelationEnumerator(JMLValueToObjectRelationImageEnumerator<K, V> ipEnum,
        ...
        //@ set returnsNull = false;
        imagePairEnum
            = (JMLValueToObjectRelationImageEnumerator<K, V>)ipEnum.clone();
    ...
    /*@ also
      ...
      @*/
    public JMLValueObjectPair<K, V> nextElement() throws JMLNoSuchElementException {
        if (imageEnum.hasMoreElements()) {
            V v = imageEnum.nextElement();
            //@ assume v != null && v instanceof _RangeType_;
            return new JMLValueObjectPair<K, V>(key, v);
        } else if (imagePairEnum.hasMoreElements()) {
            JMLValueValuePair<K, JMLObjectSet<V>> imagePair = imagePairEnum.nextElement();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueObjectPair<K, V> nextPair()
        throws JMLNoSuchElementException {
        JMLValueObjectPair<K, V> aPair = nextElement();  //@ nowarn Pre;
        //@ assume aPair != null;
        return aPair;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLValueToObjectRelationEnumerator<K, V>(imagePairEnum,
                                                          imageEnum,
                                                          key);
    } //@ nowarn Post;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLValueToObjectRelationEnumerator<K, V> js
                = (JMLValueToObjectRelationEnumerator<K, V>) oth;
    ...
    protected /*@ spec_public pure @*/ /*@ non_null @*/
        JMLValueSet<JMLValueObjectPair<K, V>> abstractValue()
    {
        JMLValueSet<JMLValueObjectPair<K, V>> ret = new JMLValueSet<JMLValueObjectPair<K, V>>();
        JMLValueToObjectRelationEnumerator<K, V> enum2
            = (JMLValueToObjectRelationEnumerator<K, V>) clone();
        while (enum2.hasMoreElements()) {
            //@ assume enum2.moreElements;
            JMLValueObjectPair<K, V> aPair = enum2.nextPair();
