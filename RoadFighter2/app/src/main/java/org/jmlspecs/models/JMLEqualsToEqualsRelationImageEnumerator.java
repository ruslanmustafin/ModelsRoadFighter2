...
/*@ nullable_by_default @*/ 
public class JMLEqualsToEqualsRelationImageEnumerator<K, V>
    implements JMLEnumeration<JMLEqualsValuePair<K, JMLEqualsSet<V>>>, JMLValueType {

    //@ public model JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> uniteratedImagePairs;     in objectState;

    /** An enumerator for the image pairs in this relation.
     */
    protected /*@ non_null @*/ JMLValueSetEnumerator<JMLEqualsValuePair<K, JMLEqualsSet<V>>> pairEnum;
    ...
    //@ public invariant elementType == \type(JMLEqualsValuePair<K, JMLEqualsSet<V>>);
    ...
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLEqualsValuePair<K, JMLEqualsSet<V>>);
    ...
    protected
        JMLEqualsToEqualsRelationImageEnumerator(/*@ non_null @*/
                                                   JMLValueSetEnumerator<JMLEqualsValuePair<K, JMLEqualsSet<V>>> pEnum)
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLEqualsValuePair);
        //@ set returnsNull = false;
        pairEnum =  (JMLValueSetEnumerator<JMLEqualsValuePair<K, JMLEqualsSet<V>>>)pEnum.clone();
    }
    ...
    public JMLEqualsValuePair<K, JMLEqualsSet<V>> nextElement() throws JMLNoSuchElementException {
        if (pairEnum.hasMoreElements()) {
            JMLEqualsValuePair<K, JMLEqualsSet<V>> o = pairEnum.nextElement();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsValuePair<K, JMLEqualsSet<V>> nextImagePair()
        throws JMLNoSuchElementException {
        //@ assume moreElements;
        JMLEqualsValuePair<K, JMLEqualsSet<V>> p = nextElement();
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLEqualsToEqualsRelationImageEnumerator<K, V>(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLEqualsToEqualsRelationImageEnumerator<K, V> js
                = (JMLEqualsToEqualsRelationImageEnumerator<K, V>) oth;
    ...
    protected /*@ spec_public pure @*/ /*@ non_null @*/
        JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> abstractValue()
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> ret = new JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>>();
        JMLEqualsToEqualsRelationImageEnumerator<K, V> enum2
            = (JMLEqualsToEqualsRelationImageEnumerator<K, V>) clone();
        while (enum2.hasMoreElements()) {
            JMLEqualsValuePair<K, JMLEqualsSet<V>> aPair = enum2.nextImagePair();
