...
/*@ nullable_by_default @*/ 
class JMLValueToObjectMap<K extends JMLType, V> extends JMLValueToObjectRelation<K, V> {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLValueToObjectMap(/*@ non_null @*/ K dv,
                                   /*@ non_null @*/ V rv)
    {
        super(dv, rv);
    }
    ...
    protected JMLValueToObjectMap(JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> ipset,
                                      JMLValueSet<K> dom,
                                      int sz)
    {
        super(ipset, dom, sz);
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLValueToObjectMap<K, V>(dv, rv));
      @*/
    public static <SK extends JMLType, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueToObjectMap<SK, SR>
        singletonMap(/*@ non_null @*/ SK dv,
                     /*@ non_null @*/ SR rv)
    {
        return new JMLValueToObjectMap<SK, SR>(dv, rv);
    }
    ...
    public static <SK extends JMLType, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueToObjectMap<SK, SR>
        singletonMap(/*@ non_null @*/ JMLValueObjectPair<SK, SR> pair)
    {
        return new JMLValueToObjectMap<SK, SR>(pair);
    }
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLValueToObjectMap<K, V>
      @          && ((JMLValueToObjectMap<K, V>)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLValueToObjectMap<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
     ...
     * @see JMLValueToObjectRelation#insert(K, V)
     */
    /*@  public normal_behavior
      @    requires dv != null && rv != null;
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToObjectMap<K, V> extend(/*@ non_null @*/ K dv,
                                       /*@ non_null @*/ V rv) 
    {
        JMLValueToObjectMap<K, V> newMap = this.removeDomainElement(dv);
        newMap = newMap.disjointUnion(new JMLValueToObjectMap<K, V>(dv, rv));
        return newMap;
    } //@ nowarn Exception;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToObjectMap<K, V> removeDomainElement(K dv)
    {
    ...
    /*@  public normal_behavior
      @    requires dom != null;
      @    ensures (\forall JMLValueObjectPair<K, V> pair; ; 
      @                 \result.theRelation.has(pair)
      @                    == 
      @                       dom.has(pair.key) 
      @                    && elementImage(pair.key).has(pair.value)
    ...
    public /*@ non_null @*/ 
        JMLValueToObjectMap<K, V>
        extendUnion(/*@ non_null @*/ JMLValueToObjectMap<K, V> othMap) 
        throws IllegalStateException
    {
        JMLValueToObjectMap<K, V> newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLValueToObjectMap<K, V>(newMap.imagePairSet_
    ...
    public /*@ non_null @*/ 
        JMLValueToObjectMap<K, V>
        clashReplaceUnion(JMLValueToObjectMap<K, V> othMap,
                          V errval)
        throws IllegalStateException
    {
        ...
        JMLValueToObjectRelation<K, V> newRel;
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLValueToObjectRelation<K, V>(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLValueToObjectMap<K, V> 
        disjointUnion(/*@ non_null @*/ JMLValueToObjectMap<K, V> othMap) 
        throws JMLMapException, IllegalStateException
    {
        ...
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLValueToObjectMap<K, V>(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
