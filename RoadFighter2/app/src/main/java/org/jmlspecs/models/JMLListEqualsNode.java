...
/*@ nullable_by_default @*/ 
/*@ pure spec_public @*/ class JMLListEqualsNode<E> implements JMLType {
    ...
    public static <F> /*@ pure @*/
        JMLListEqualsNode<F> cons(/*@ nullable @*/ F hd, /*@ nullable @*/ JMLListEqualsNode<F> tl) {
        if (hd == null) {
            JMLListEqualsNode<F> ret = new JMLListEqualsNode<F>(null, tl);
            //@ assume ret.containsNull;
            return ret;
        } else {
            F h = hd ;
            //@ assume h != null && h instanceof Object;
            JMLListEqualsNode<F> ret = new JMLListEqualsNode<F>(h, tl);
    ...
    /*@  public normal_behavior
      ...
      @    ensures !\result;
      @*/
    public boolean isPrefixOf(JMLListEqualsNode<E> ls2) {
        if (ls2 == null) {
            return false;
        }
        JMLListEqualsNode<E> othLst = ls2;
    ...
    public boolean equals(/*@ nullable @*/ Object ls2) {
        if (ls2 != null && ls2 instanceof JMLListEqualsNode) {
            JMLListEqualsNode<E> othLst = (JMLListEqualsNode<E>)ls2;
            JMLListEqualsNode<E> thisLst = this;
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListEqualsNode<E> prefix(int n) {
        return (n <= 0 
                ? null 
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListEqualsNode<E> removeItemAt(int n) {
        return (n <= 0 
                ? next
                : (next == null ? null 
                   : new JMLListEqualsNode<E>(val, next.removeItemAt(n-1)))
                );
    }
    ...
    public JMLListEqualsNode<E> removeLast() {
        return (next == null 
                ? null 
                : new JMLListEqualsNode<E>(val, next.removeLast()));
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLListEqualsNode<E> insertBefore(int n, E item) 
        throws JMLListException {
        if ( n < 0 || (n > 1 && next == null) ) {
            throw new JMLListException("Index to insertBefore out of range.");
        } else if (n == 0) {
            ...
            //@ assert n > 0;
            return new JMLListEqualsNode<E>(val,
                                         (next == null
                                          ? cons(item, null)
                                          : next.insertBefore(n-1, item)));
        }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLListEqualsNode<E> remove(E item) {
        if (item == null) {
            if (val == null) {
                return next;
            } else {
