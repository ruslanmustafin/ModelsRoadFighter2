 ...
 */
//-@ immutable
public /*@ pure @*/ class JMLValueToObjectRelation<K extends JMLType, V>
    implements JMLCollection<JMLValueObjectPair<K, V>> {

    /** The set of pairs of keys and values conceptually contained in
     * this object.
     */
    //@ public model JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>> theRelation;
    /*@ public invariant
     ...
     */
    protected final /*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> imagePairSet_;
    //@                                             in theRelation;
    ...
    /*@  public normal_behavior
      ...
      @    ensures theRelation.equals(new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>());
    ...
    public JMLValueToObjectRelation()
    {
        ...
        imagePairSet_ = new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>();
        size_ = 0;
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLValueToObjectRelation(/*@ non_null @*/ K dv,
                                        /*@ non_null @*/ V rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
        ...
        imagePairSet_ = new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>(new JMLValueValuePair<K, JMLObjectSet<V>>(dv, img));
    }

    /** Initialize this to be a relation containing a single association
     *  given by the pair.
     * @see #singleton(JMLValueObjectPair)
     * @see #JMLValueToObjectRelation(K, V)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLValueToObjectRelation(/*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> ipset, 
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLValueToObjectRelation<SK, SR>(dv, rv));
      @*/
    public static <SK extends JMLType, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueToObjectRelation<SK, SR>
        singleton(/*@ non_null @*/ SK dv,
                  /*@ non_null @*/ SR rv) {
        return new JMLValueToObjectRelation<SK, SR>(dv, rv);
    }
    ...
    public static <SK extends JMLType, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueToObjectRelation<SK, SR>
        singleton(/*@ non_null @*/ JMLValueObjectPair<SK, SR> pair)
    {
    ...
    {
        JMLValueToObjectRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
        JMLValueValuePair<K, JMLObjectSet<V>> imagePair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectSet<V> image(/*@ non_null @*/ JMLValueSet<K> dom)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLObjectToValueRelation<V, K> inverse()
    {
        JMLObjectToValueRelation<V, K> invRel
            = new JMLObjectToValueRelation<V, K>();
        JMLValueToObjectRelationEnumerator<K, V> assocEnum = this.associations();
        JMLValueObjectPair<K, V> pair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet<K> inverseImage(/*@ non_null @*/ JMLObjectSet<V> rng)
    {
        JMLValueSet<K> invImg = new JMLValueSet<K>();
        JMLValueToObjectRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLValueObjectPair<K, V> pair)
    {
    ...
    /*@ also
      ...
      @              obj != null
      @           && obj instanceof JMLValueObjectPair
      @           && has((JMLValueObjectPair<K, V>) obj);
      @*/
    ...
    {
        return new
            JMLValueToObjectRelation<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        ...
        JMLValueToObjectRelation<K, V> rel
            = (JMLValueToObjectRelation<K, V>) obj;
    ...
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLValueToObjectRelation<K, V> add(/*@ non_null @*/ K dv,
                                         /*@ non_null @*/ V rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> newImagePairSet;
        ...
        if (!domain_.has(dv)) {
            ...
            newImagePairSet
                = imagePairSet_.insert(new JMLValueValuePair<K, JMLObjectSet<V>>(dv, img));
        } else {
            newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>();
            newDom = domain_;
            newSize = 0;
            ...
            while (imagePairEnum.hasMoreElements()) {
                ...
                newImagePairSet 
                    = newImagePairSet
                    .insert(new JMLValueValuePair<K, JMLObjectSet<V>>(imagePair.key, img));
            }
        }
        return new JMLValueToObjectRelation<K, V>(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation<K, V> insert(/*@ non_null @*/
                                         JMLValueObjectPair<K, V> pair)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation<K, V> removeFromDomain(/*@ nullable @*/ K dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> newImagePairSet
				= new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation<K, V> remove(K dv, V rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>();
        ...
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imagePair.keyEquals(dv)) {
                ...
                if (imgSize > 0) {
                    newImagePairSet
                        = newImagePairSet
                        .insert(new JMLValueValuePair<K, JMLObjectSet<V>>(dv, img));
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation<K, V> remove(/*@ non_null @*/
                                            JMLValueObjectPair<K, V> pair)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToObjectRelation<K, V> 
        union(/*@ non_null @*/ JMLValueToObjectRelation<K, V> othRel)
        throws IllegalStateException
    {
        JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>();
        JMLValueSet<K> newDom = domain_;
        ...
        return new JMLValueToObjectRelation<K, V>(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLValueToObjectRelation<K, V>
        intersection(/*@ non_null @*/ JMLValueToObjectRelation<K, V> othRel)
    {
        JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>();
    ...
    public /*@ non_null @*/  
        JMLValueToObjectRelation<K, V>
        difference(/*@ non_null @*/ JMLValueToObjectRelation<K, V> othRel)
    {
        JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>>();
        JMLValueSet<K> newDom = new JMLValueSet<K>();
        int newSize = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToObjectRelationEnumerator<K, V> associations()
    {
        return new JMLValueToObjectRelationEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToObjectRelationEnumerator<K, V> elements()
    {
        return associations();
    }
    ...
    public JMLIterator<JMLValueObjectPair<K, V>> iterator() {
        return new JMLEnumerationToIterator<JMLValueObjectPair<K, V>>(elements());
    }  //@ nowarn Post;
    ...
    /*@ public normal_behavior
      ...
      @             
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLValueObjectPair<K, V>> toSet() {
        JMLValueToObjectRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSet<JMLValueObjectPair<K, V>> ret = new JMLValueSet<JMLValueObjectPair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLValueObjectPair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
        }
        return ret;
    } //@ nowarn Exception;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueBag<JMLValueObjectPair<K, V>> toBag() {
        JMLValueToObjectRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueBag<JMLValueObjectPair<K, V>> ret = new JMLValueBag<JMLValueObjectPair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLValueObjectPair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSequence<JMLValueObjectPair<K, V>> toSequence() {
        JMLValueToObjectRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSequence<JMLValueObjectPair<K, V>> ret = new JMLValueSequence<JMLValueObjectPair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLValueObjectPair<K, V> p = pairEnum.nextPair();
    ...
    /*@ public normal_behavior
      ...
      @                \result.has(
      @                    new JMLValueValuePair<K, JMLObjectSet<V>>(dv, elementImage(dv))));
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> imagePairSet() {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToObjectRelationImageEnumerator<K, V> imagePairs() {
        return new JMLValueToObjectRelationImageEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueToObjectMap<K, V> toFunction()
    {
        JMLValueSet<K> newDom = domain_;
        int newSize = domain_.int_size();

        JMLValueSet<JMLValueValuePair<K, JMLObjectSet<V>>> newImagePairSet = imagePairSet_;
        ...
        return new JMLValueToObjectMap<K, V>(newImagePairSet, newDom, newSize);
    } //@ nowarn Exception;
}
