...
/*@ nullable_by_default @*/ 
public class JMLObjectSequenceEnumerator<E>
    implements JMLEnumeration<E>, JMLObjectType
{

    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLObjectSequence<E> uniteratedElems; in objectState;
    ...
    /*@ protected represents uniteratedElems
      @                  <- new JMLObjectSequence<E>(currentNode, remaining);
      @*/
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLObjectSequenceEnumerator(/*@ non_null @*/ JMLObjectSequence<E> s) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return
            new JMLObjectSequenceEnumerator<E>(new JMLObjectSequence<E>(currentNode,
                                                                  remaining));
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLObjectSequenceEnumerator)) {
            ...
            JMLObjectSequenceEnumerator<E> js
                = (JMLObjectSequenceEnumerator<E>) oth;
            if (currentNode == null) {
