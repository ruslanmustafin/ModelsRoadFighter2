...
/*@ nullable_by_default @*/ 
/*@ pure spec_public @*/ class JMLListObjectNode<E> implements JMLType {
     ...
     */
    public final JMLListObjectNode<E> next;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLListObjectNode(E item, JMLListObjectNode<E> nxt) {
        //@ set owner = null;
        val = item;
        next = nxt;
        /*@ set elementType
    ...
    public static <F> /*@ pure @*/
        JMLListObjectNode<F> cons(/*@ nullable @*/ F hd, /*@ nullable @*/ JMLListObjectNode<F> tl) {
        if (hd == null) {
            JMLListObjectNode<F> ret = new JMLListObjectNode<F>(null, tl);
            //@ assume ret.containsNull;
            return ret;
        } else {
            F h = hd ;
            //@ assume h != null && h instanceof Object;
            JMLListObjectNode<F> ret = new JMLListObjectNode<F>(h, tl);
    ...
    /*@  public normal_behavior
      ...
      @    ensures !\result;
      @*/
    public boolean isPrefixOf(JMLListObjectNode<E> ls2) {
        if (ls2 == null) {
            return false;
        }
        JMLListObjectNode<E> othLst = ls2;
        JMLListObjectNode<E> thisLst = this;
        /*@ maintaining
    ...
    public boolean equals(/*@ nullable @*/ Object ls2) {
        if (ls2 != null && ls2 instanceof JMLListObjectNode) {
            JMLListObjectNode<E> othLst = (JMLListObjectNode<E>)ls2;
            JMLListObjectNode<E> thisLst = this;
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListObjectNode<E> prefix(int n) {
        return (n <= 0 
                ? null 
                : new JMLListObjectNode<E>(val, 
                                        (next == null ? null 
                                         : next.prefix(n-1)))
                );
    }
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListObjectNode<E> removePrefix(int n) {
        return (n <= 0 
                ? this
                : (next == null ? null : next.removePrefix(n-1))
                );
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListObjectNode<E> removeItemAt(int n) {
        return (n <= 0 
                ? next
                : (next == null ? null 
                   : new JMLListObjectNode<E>(val, next.removeItemAt(n-1)))
                );
    }
    ...
    /*@  public normal_behavior
      ...
      @            ==> !\result.containsNull;
      @*/
    public JMLListObjectNode<E> replaceItemAt(int n, E item) {
        return (n <= 0 
                ? cons(item, next) // cons() handles any necessary cloning
                : (next == null ? null 
                   : new JMLListObjectNode<E>(val, 
    ...
    /*@  public normal_behavior // !FIXME! inconsistent spec [when int_length() == 1]
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListObjectNode<E> removeLast() {
        return (next == null 
                ? null 
                : new JMLListObjectNode<E>(val, next.removeLast()));
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLListObjectNode<E> concat(/*@ non_null @*/ JMLListObjectNode<E> ls2)
    {
        return (next == null
                ? new JMLListObjectNode<E>(val, ls2)
                : new JMLListObjectNode<E>(val, next.concat(ls2))
                );
    }
    ...
    /*@  public normal_behavior
      ...
      @         && \result.int_length() == int_length() + 1;
      @*/
    public /*@ non_null @*/ JMLListObjectNode<E> prepend(E item) {
    ...
    /*@  public normal_behavior
      ...
      @         && \result.int_length() == int_length() + 1;
      @*/
    public /*@ non_null @*/ JMLListObjectNode<E> append(E item) {
        ...
        JMLListObjectNode<E> ptr = this;
        JMLListObjectNode<E> revret = null;
        //@ maintaining (* reverse(revret) concatenated with ptr equals this *);
        while (ptr != null) {
            revret = new JMLListObjectNode<E>(ptr.val, revret); // don't clone yet
            ptr = ptr.next;
        }
        return (new JMLListObjectNode<E>(item, revret)).reverse();
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLListObjectNode<E> reverse() {
        JMLListObjectNode<E> ptr = this;
        JMLListObjectNode<E> ret = null;
        //@ loop_invariant ptr != this ==> ret != null;
        //@ maintaining (* ret is the reverse of items in this up to ptr *);
        while (ptr != null) {
            //@ assume ptr.val != null ==> \typeof(ptr.val) <: elementType;
            ret = new JMLListObjectNode<E>(ptr.val == null ? null
                                        : (ptr.val) ,
                                        ret);
            ptr = ptr.next;
        }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLListObjectNode<E> insertBefore(int n, E item) 
        throws JMLListException {
        if ( n < 0 || (n > 1 && next == null) ) {
            throw new JMLListException("Index to insertBefore out of range.");
        } else if (n == 0) {
            ...
            //@ assert n > 0;
            return new JMLListObjectNode<E>(val,
                                         (next == null
                                          ? cons(item, null)
                                          : next.insertBefore(n-1, item)));
        }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLListObjectNode<E> remove(E item) {
        if (item == null) {
            if (val == null) {
                return next;
            } else {
