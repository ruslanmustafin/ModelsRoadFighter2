...
/*@ nullable_by_default @*/ 
public class JMLEqualsToObjectRelationImageEnumerator<K, V>
    implements JMLEnumeration<JMLEqualsValuePair<K, JMLObjectSet<V>>>, JMLValueType {

    //@ public model JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> uniteratedImagePairs;     in objectState;

    /** An enumerator for the image pairs in this relation.
     */
    protected /*@ non_null @*/ JMLValueSetEnumerator<JMLEqualsValuePair<K, JMLObjectSet<V>>> pairEnum;
    ...
    //@ public invariant elementType == \type(JMLEqualsValuePair<K, JMLObjectSet<V>>);
    ...
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLEqualsValuePair<K, JMLObjectSet<V>>);
    ...
    protected
        JMLEqualsToObjectRelationImageEnumerator(/*@ non_null @*/
                                                   JMLValueSetEnumerator<JMLEqualsValuePair<K, JMLObjectSet<V>>> pEnum)
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLEqualsValuePair);
        //@ set returnsNull = false;
        pairEnum =  (JMLValueSetEnumerator<JMLEqualsValuePair<K, JMLObjectSet<V>>>)pEnum.clone();
    }
    ...
    /*@ also
      ...
      @*/
    public JMLEqualsValuePair<K, JMLObjectSet<V>> nextElement() throws JMLNoSuchElementException {
        if (pairEnum.hasMoreElements()) {
            JMLEqualsValuePair<K, JMLObjectSet<V>> o = pairEnum.nextElement();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsValuePair<K, JMLObjectSet<V>> nextImagePair()
        throws JMLNoSuchElementException {
        //@ assume moreElements;
        JMLEqualsValuePair<K, JMLObjectSet<V>> p = nextElement();
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLEqualsToObjectRelationImageEnumerator<K, V>(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLEqualsToObjectRelationImageEnumerator<K, V> js
                = (JMLEqualsToObjectRelationImageEnumerator<K, V>) oth;
    ...
    protected /*@ spec_public pure @*/ /*@ non_null @*/
        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> abstractValue()
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> ret = new JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>>();
        JMLEqualsToObjectRelationImageEnumerator<K, V> enum2
            = (JMLEqualsToObjectRelationImageEnumerator<K, V>) clone();
        while (enum2.hasMoreElements()) {
            JMLEqualsValuePair<K, JMLObjectSet<V>> aPair = enum2.nextImagePair();
