...
/*@ nullable_by_default @*/ 
class JMLValueToEqualsMap<K extends JMLType, V> extends JMLValueToEqualsRelation<K, V> {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLValueToEqualsMap(/*@ non_null @*/ K dv,
                                   /*@ non_null @*/ V rv)
    {
        super(dv, rv);
    }
    ...
    protected JMLValueToEqualsMap(JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> ipset,
                                      JMLValueSet<K> dom,
                                      int sz)
    {
        super(ipset, dom, sz);
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLValueToEqualsMap<K, V>(dv, rv));
      @*/
    public static <SK extends JMLType, SR> /*@ pure @*/ /*@ non_null @*/
        JMLValueToEqualsMap<SK, SR>
        singletonMap(/*@ non_null @*/ SK dv,
                     /*@ non_null @*/ SR rv)
    {
        return new JMLValueToEqualsMap<SK, SR>(dv, rv);
    }
    ...
    public static <SK extends JMLType, SR> /*@ pure @*/ /*@ non_null @*/
        JMLValueToEqualsMap<SK, SR>
        singletonMap(/*@ non_null @*/ JMLValueEqualsPair<SK, SR> pair)
    {
        return new JMLValueToEqualsMap<SK, SR>(pair);
    }
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLValueToEqualsMap<K, V>
      @          && ((JMLValueToEqualsMap<K, V>)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLValueToEqualsMap<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
     ...
     * @see JMLValueToEqualsRelation#insert(K, V)
     */
    /*@  public normal_behavior
      @    requires dv != null && rv != null;
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToEqualsMap<K, V> extend(/*@ non_null @*/ K dv,
                                       /*@ non_null @*/ V rv) 
    {
        JMLValueToEqualsMap<K, V> newMap = this.removeDomainElement(dv);
        newMap = newMap.disjointUnion(new JMLValueToEqualsMap<K, V>(dv, rv));
        return newMap;
    } //@ nowarn Exception;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToEqualsMap<K, V> removeDomainElement(K dv)
    {
    ...
    /*@  public normal_behavior
      @    requires dom != null;
      @    ensures (\forall JMLValueEqualsPair<K, V> pair; ; 
      @                 \result.theRelation.has(pair)
      @                    == 
      @                       dom.has(pair.key) 
      @                    && elementImage(pair.key).has(pair.value)
    ...
    public /*@ non_null @*/ 
        JMLValueToEqualsMap<K, V>
        extendUnion(/*@ non_null @*/ JMLValueToEqualsMap<K, V> othMap) 
        throws IllegalStateException
    {
        JMLValueToEqualsMap<K, V> newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLValueToEqualsMap<K, V>(newMap.imagePairSet_
    ...
    public /*@ non_null @*/ 
        JMLValueToEqualsMap<K, V>
        clashReplaceUnion(JMLValueToEqualsMap<K, V> othMap,
                          V errval)
        throws IllegalStateException
    {
        ...
        JMLValueToEqualsRelation<K, V> newRel;
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLValueToEqualsRelation<K, V>(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLValueToEqualsMap<K, V> 
        disjointUnion(/*@ non_null @*/ JMLValueToEqualsMap<K, V> othMap) 
        throws JMLMapException, IllegalStateException
    {
        ...
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLValueToEqualsMap<K, V>(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
