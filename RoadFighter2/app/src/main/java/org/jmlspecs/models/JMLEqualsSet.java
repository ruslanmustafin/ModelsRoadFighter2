...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLEqualsSet<E>
    implements JMLCollection<E>
{
     ...
     */
    /*@ public normal_behavior
      @    ensures \result != null && \result.equals(new JMLEqualsSet<F>(e));
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSet<F> singleton(F e)
    {
        return new JMLEqualsSet<F>(e);
    }
    ...
    /*@ public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSet<F> convertFrom(/*@ non_null @*/ F[] a)
    {
        /*@ non_null @*/ JMLEqualsSet<F> ret = EMPTY;
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSet<F> convertFrom(/*@ non_null @*/ java.util.Collection<F> c)
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSet<F> convertFrom(/*@ non_null @*/ JMLCollection<F> c)
        throws ClassCastException
    {
        /*@ non_null @*/ JMLEqualsSet<F> ret = EMPTY;
    ...
    /*@ also
      ...
      @                                      == ((JMLEqualsSet<E>)s2).has(e));
      @     ensures_redundantly \result ==>
      @             s2 != null && s2 instanceof JMLEqualsSet
      @             && containsNull == ((JMLEqualsSet<E>)s2).containsNull;
      @*/
    public boolean equals(/*@ nullable @*/ Object s2) {
        return (s2 != null && s2 instanceof JMLEqualsSet)
            && (size == ((JMLEqualsSet<E>)s2).int_size())
            && isSubset((JMLEqualsSet<E>)s2);
    }
    ...
    public int hashCode() {
        if (size == 0) {
            ...
            int hash = 0xffff;
            JMLListEqualsNode<E> walker = the_list;
            while (walker != null) {
                E wv = walker.val;
                if (wv != null) {
                    hash ^= wv.hashCode();
     ...
     * @see #isProperSubset(JMLEqualsSet<E>)
     * @see #isSuperset(JMLEqualsSet<E>)
     */
    /*@ public normal_behavior
      @    requires s2 != null;
      ...
      @*/  
    public boolean isSubset(/*@ non_null @*/ JMLEqualsSet<E> s2) {
        if (size > s2.int_size()) {
            return false;
        } else {
            for (JMLListEqualsNode<E> walker = the_list;
                 walker != null;
                 walker = walker.next) {
     ...
     * argument.
     * @see #isSubset(JMLEqualsSet<E>)
     * @see #isProperSuperset(JMLEqualsSet<E>)
     */
    /*@ public normal_behavior
      @    requires s2 != null;
      @    ensures \result <==>
      ...
      @*/    
    public boolean isProperSubset(/*@ non_null @*/ JMLEqualsSet<E> s2) {
    ...
    /*@ public normal_behavior
      ...
      @*/    
    public boolean isSuperset(/*@ non_null @*/ JMLEqualsSet<E> s2) {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public boolean isProperSuperset(/*@ non_null @*/ JMLEqualsSet<E> s2) {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsSet<E> remove(E elem) {
        if (!has(elem)) {
            return this;
        } else {
            //@ assume the_list != null;
            JMLListEqualsNode<E> new_list = the_list.remove(elem);
            //@ assume (new_list == null) == (size == 1);
            return new JMLEqualsSet<E>(new_list, size - 1);
        }
    } //@ nowarn Post;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet<E> intersection(/*@ non_null @*/ JMLEqualsSet<E> s2) {
        JMLEqualsSet<E> returnSet = new JMLEqualsSet<E>();
        JMLListEqualsNode<E> thisWalker = the_list;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsSet<JMLEqualsSet<E>> powerSet()
        throws IllegalStateException
    {
        if (size >= 32) {
        ...
        /*@ non_null @*/ JMLEqualsSet<JMLEqualsSet<E>> ret
                             = new JMLEqualsSet<JMLEqualsSet<E>>(JMLEqualsSet.EMPTY);
        ...
        while (elems.hasNext()) { 
            E cur = elems.next();
            JMLIterator<JMLEqualsSet<E>> size_i_and_smaller_subsets = ret.iterator();
            while (size_i_and_smaller_subsets.hasNext()) {
                JMLEqualsSet<E> subset = size_i_and_smaller_subsets.next();
                if (cur == null) {
    ...
    public /*@ non_null @*/ JMLEqualsSetEnumerator<E> elements() {
        return new JMLEqualsSetEnumerator<E>(this);
    }  
    ...
    public /*@ non_null @*/ String toString() {
        ...
        JMLListEqualsNode<E> setWalker = the_list;
        if (setWalker != null) {
