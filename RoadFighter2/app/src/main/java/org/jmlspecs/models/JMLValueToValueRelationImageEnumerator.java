...
/*@ nullable_by_default @*/ 
public class JMLValueToValueRelationImageEnumerator<K extends JMLType, V extends JMLType>
    implements JMLEnumeration<JMLValueValuePair<K, JMLValueSet<V>>>, JMLValueType {

    //@ public model JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> uniteratedImagePairs;     in objectState;

    /** An enumerator for the image pairs in this relation.
     */
    protected /*@ non_null @*/ JMLValueSetEnumerator<JMLValueValuePair<K, JMLValueSet<V>>> pairEnum;
    ...
    //@ public invariant elementType == \type(JMLValueValuePair<K, JMLValueSet<V>>);
    ...
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLValueValuePair<K, JMLValueSet<V>>);
    ...
    protected
        JMLValueToValueRelationImageEnumerator(/*@ non_null @*/
                                                   JMLValueSetEnumerator<JMLValueValuePair<K, JMLValueSet<V>>> pEnum)
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLValueValuePair);
        //@ set returnsNull = false;
        pairEnum =  (JMLValueSetEnumerator<JMLValueValuePair<K, JMLValueSet<V>>>)pEnum.clone();
    }
    ...
    public JMLValueValuePair<K, JMLValueSet<V>> nextElement() throws JMLNoSuchElementException {
        if (pairEnum.hasMoreElements()) {
            JMLValueValuePair<K, JMLValueSet<V>> o = pairEnum.nextElement();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueValuePair<K, JMLValueSet<V>> nextImagePair()
        throws JMLNoSuchElementException {
        //@ assume moreElements;
        JMLValueValuePair<K, JMLValueSet<V>> p = nextElement();
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLValueToValueRelationImageEnumerator<K, V>(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLValueToValueRelationImageEnumerator<K, V> js
                = (JMLValueToValueRelationImageEnumerator<K, V>) oth;
    ...
    protected /*@ spec_public pure @*/ /*@ non_null @*/
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> abstractValue()
    {
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> ret = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        JMLValueToValueRelationImageEnumerator<K, V> enum2
            = (JMLValueToValueRelationImageEnumerator<K, V>) clone();
        while (enum2.hasMoreElements()) {
            JMLValueValuePair<K, JMLValueSet<V>> aPair = enum2.nextImagePair();
