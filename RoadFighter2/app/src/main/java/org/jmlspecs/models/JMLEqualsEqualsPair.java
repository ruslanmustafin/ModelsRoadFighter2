...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLEqualsEqualsPair<K, V> implements JMLType {
     ...
     */
    public /*@ extract @*/ JMLEqualsEqualsPair(/*@ non_null @*/ K dv,
                               /*@ non_null @*/ V rv)
    ...
    {
        return new JMLEqualsEqualsPair<K, V>(key, value);
    } //@ nowarn Post;
