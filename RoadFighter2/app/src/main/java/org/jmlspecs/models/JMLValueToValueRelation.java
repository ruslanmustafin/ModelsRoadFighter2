 ...
 */
//-@ immutable
public /*@ pure @*/ class JMLValueToValueRelation<K extends JMLType, V extends JMLType>
    implements JMLCollection<JMLValueValuePair<K, V>> {

    /** The set of pairs of keys and values conceptually contained in
     * this object.
     */
    //@ public model JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>> theRelation;
    /*@ public invariant
     ...
     */
    protected final /*@ non_null @*/ JMLValueSet<K> domain_;
    //@                                             in theRelation;
     ...
     */
    protected final /*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> imagePairSet_;
    //@                                             in theRelation;
    ...
    /*@  public normal_behavior
      ...
      @    ensures theRelation.equals(new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>());
    ...
    public JMLValueToValueRelation()
    {
        ...
        domain_ = new JMLValueSet<K>();
        imagePairSet_ = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        size_ = 0;
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLValueToValueRelation(/*@ non_null @*/ K dv,
                                        /*@ non_null @*/ V rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
        //@ set elementType = \type(JMLValueValuePair);
        size_ = 1;
        domain_ = new JMLValueSet<K>(dv);
        JMLValueSet<V> img = new JMLValueSet<V>(rv);
        imagePairSet_ = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>(new JMLValueValuePair<K, JMLValueSet<V>>(dv, img));
    }

    /** Initialize this to be a relation containing a single association
     *  given by the pair.
     * @see #singleton(JMLValueValuePair)
     * @see #JMLValueToValueRelation(K, V)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLValueToValueRelation(/*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> ipset, 
                                     /*@ non_null @*/ JMLValueSet<K> dom, 
                                     int sz)
    {
        //@ set owner = null;
        //@ set containsNull = false;
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLValueToValueRelation<SK, SR>(dv, rv));
      @*/
    public static <SK extends JMLType, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueToValueRelation<SK, SR>
        singleton(/*@ non_null @*/ SK dv,
                  /*@ non_null @*/ SR rv) {
        return new JMLValueToValueRelation<SK, SR>(dv, rv);
    }
    ...
    public static <SK extends JMLType, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueToValueRelation<SK, SR>
        singleton(/*@ non_null @*/ JMLValueValuePair<SK, SR> pair)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet<V> elementImage(/*@ nullable @*/ K dv)
    {
        JMLValueToValueRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
        JMLValueValuePair<K, JMLValueSet<V>> imagePair;
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imagePair.keyEquals(dv)) {
                ...
                JMLValueSet<V> res = imagePair.value;
                //@ assume !res.containsNull;
                return res;
            }
        }
        return new JMLValueSet<V>();
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet<V> image(/*@ non_null @*/ JMLValueSet<K> dom)
    {
        JMLValueSet<V> img = new JMLValueSet<V>();
        JMLValueToValueRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
        JMLValueValuePair<K, JMLValueSet<V>> imagePair;
        ...
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (dom.has(imagePair.key)) {
                JMLValueSet<V> ipv = imagePair.value;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueToValueRelation<V, K> inverse()
    {
        JMLValueToValueRelation<V, K> invRel
            = new JMLValueToValueRelation<V, K>();
        JMLValueToValueRelationEnumerator<K, V> assocEnum = this.associations();
        JMLValueValuePair<K, V> pair;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet<K> inverseElementImage(V rv)
    {
        JMLValueSet<K> invImg = new JMLValueSet<K>();
        JMLValueToValueRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
        JMLValueValuePair<K, JMLValueSet<V>> imagePair;
        ...
        while (imagePairEnum.hasMoreElements()) { //@ nowarn LoopInv;
            ...
            //@ assume imagePair.value instanceof JMLValueSet;
            JMLValueSet<V> img = imagePair.value;
            if (img.has(rv)) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet<K> inverseImage(/*@ non_null @*/ JMLValueSet<V> rng)
    {
        JMLValueSet<K> invImg = new JMLValueSet<K>();
        JMLValueToValueRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLValueValuePair<K, V> pair)
    {
    ...
    {
        return new
            JMLValueToValueRelation<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        ...
        JMLValueToValueRelation<K, V> rel
            = (JMLValueToValueRelation<K, V>) obj;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSet<K> domain()
    {
        return domain_;
    }
    ...
    /*@  public normal_behavior
      ...
      @                );
      @*/
    public /*@ non_null @*/ JMLValueSet<V> range()
    {
        JMLValueSet<V> rangeSet = new JMLValueSet<V>();
    ...
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLValueToValueRelation<K, V> add(/*@ non_null @*/ K dv,
                                         /*@ non_null @*/ V rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet;
        JMLValueSet<K> newDom;
        int newSize;
        JMLValueSet<V> img;
        ...
        if (!domain_.has(dv)) {
            ...
            newSize = size_ + 1;
            img = new JMLValueSet<V>(rv);
            newImagePairSet
                = imagePairSet_.insert(new JMLValueValuePair<K, JMLValueSet<V>>(dv, img));
        } else {
            newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
            newDom = domain_;
            newSize = 0;
            ...
            while (imagePairEnum.hasMoreElements()) {
                ...
                newImagePairSet 
                    = newImagePairSet
                    .insert(new JMLValueValuePair<K, JMLValueSet<V>>(imagePair.key, img));
            }
        }
        return new JMLValueToValueRelation<K, V>(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToValueRelation<K, V> insert(/*@ non_null @*/
                                         JMLValueValuePair<K, V> pair)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToValueRelation<K, V> removeFromDomain(/*@ nullable @*/ K dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet
				= new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        JMLValueSet<K> newDom = domain_.remove(dv);
        int newSize = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToValueRelation<K, V> remove(K dv, V rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        JMLValueSet<K> newDom = domain_;
        int newSize = 0;
        ...
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imagePair.keyEquals(dv)) {
                ...
                if (imgSize > 0) {
                    newImagePairSet
                        = newImagePairSet
                        .insert(new JMLValueValuePair<K, JMLValueSet<V>>(dv, img));
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToValueRelation<K, V> remove(/*@ non_null @*/
                                            JMLValueValuePair<K, V> pair)
    {
    ...
    public /*@ non_null @*/ <D extends JMLType>
        JMLValueToValueRelation<D, V>
        compose(/*@ non_null @*/ JMLValueToValueRelation<D, K> othRel)
    {
        JMLValueSet<JMLValueValuePair<D, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<D, JMLValueSet<V>>>();
        JMLValueSet<D> newDom = new JMLValueSet<D>();
        int newSize = 0;

        JMLValueToValueRelationImageEnumerator<D, K> imagePairEnum
            = othRel.imagePairs();
        JMLValueValuePair<D, JMLValueSet<K>> imagePair;
        JMLValueSet<K> img1;
        JMLValueSet<V> img2;
        int imgSize;
        while (imagePairEnum.hasMoreElements()) {
            ...
            //@ assume imagePair.value != null;
            //@ assume imagePair.value instanceof JMLValueSet;
            img1 = (JMLValueSet<K>)imagePair.value;
            img2 = this.image(img1);
            imgSize = img2.int_size();
            if (imgSize > 0) {
                newImagePairSet
                    = newImagePairSet
                    .insert(new JMLValueValuePair<D, JMLValueSet<V>>(imagePair.key, img2));
                newSize = newSize + imgSize;
                newDom = newDom.insert(imagePair.key);
            }
        }
        return new JMLValueToValueRelation<D, V>(newImagePairSet, newDom, newSize);
    } //@ nowarn Exception;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ <D>
        JMLObjectToValueRelation<D, V>
        compose(/*@ non_null @*/ JMLObjectToValueRelation<D, K> othRel)
    {
        JMLValueSet<JMLObjectValuePair<D, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLObjectValuePair<D, JMLValueSet<V>>>();
        JMLObjectSet<D> newDom = new JMLObjectSet<D>();
        int newSize = 0;

        JMLObjectToValueRelationImageEnumerator<D, K> imagePairEnum
            = othRel.imagePairs();
        JMLObjectValuePair<D, JMLValueSet<K>> imagePair;
        JMLValueSet<K> img1;
        JMLValueSet<V> img2;
        int imgSize;
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imgSize > 0) {
                newImagePairSet
                    = newImagePairSet
                    .insert(new JMLObjectValuePair<D, JMLValueSet<V>>(imagePair.key, img2));
                newSize = newSize + imgSize;
                newDom = newDom.insert(imagePair.key);
            }
        }
        return new JMLObjectToValueRelation<D, V>(newImagePairSet, newDom,
                                              newSize);
    } //@ nowarn Exception;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLValueToValueRelation<K, V> 
        union(/*@ non_null @*/ JMLValueToValueRelation<K, V> othRel)
        throws IllegalStateException
    {
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        JMLValueSet<K> newDom = domain_;
        ...
        JMLValueSet<K> diffDom = othRel.domain().difference(this.domain_);
        ...
        return new JMLValueToValueRelation<K, V>(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLValueToValueRelation<K, V>
        intersection(/*@ non_null @*/ JMLValueToValueRelation<K, V> othRel)
    {
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        JMLValueSet<K> newDom = new JMLValueSet<K>();
        int newSize = 0;
    ...
    public /*@ non_null @*/  
        JMLValueToValueRelation<K, V>
        difference(/*@ non_null @*/ JMLValueToValueRelation<K, V> othRel)
    {
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        JMLValueSet<K> newDom = new JMLValueSet<K>();
        int newSize = 0;
    ...
    public /*@ non_null @*/ 
        JMLValueToValueRelation<K, V> 
        restrictDomainTo(/*@ non_null @*/ JMLValueSet<K> dom)
    {
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        JMLValueSet<K> newDom = domain_.intersection(dom);
    ...
    public /*@ non_null @*/ 
        JMLValueToValueRelation<K, V>
        restrictRangeTo(/*@ non_null @*/ JMLValueSet<V> rng)
    {
        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet = new JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>>();
        JMLValueSet<K> newDom = new JMLValueSet<K>();
        int newSize = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToValueRelationEnumerator<K, V> associations()
    {
        return new JMLValueToValueRelationEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToValueRelationEnumerator<K, V> elements()
    {
        return associations();
    }
    ...
    public JMLIterator<JMLValueValuePair<K, V>> iterator() {
        return new JMLEnumerationToIterator<JMLValueValuePair<K, V>>(elements());
    }  //@ nowarn Post;
    ...
    /*@ public normal_behavior
      ...
      @             
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, V>> toSet() {
        JMLValueToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSet<JMLValueValuePair<K, V>> ret = new JMLValueSet<JMLValueValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLValueValuePair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
        }
        return ret;
    } //@ nowarn Exception;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueBag<JMLValueValuePair<K, V>> toBag() {
        JMLValueToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueBag<JMLValueValuePair<K, V>> ret = new JMLValueBag<JMLValueValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLValueValuePair<K, V> p = pairEnum.nextPair();
            ret = ret.insert(p);
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSequence<JMLValueValuePair<K, V>> toSequence() {
        JMLValueToValueRelationEnumerator<K, V> pairEnum = this.associations();
        JMLValueSequence<JMLValueValuePair<K, V>> ret = new JMLValueSequence<JMLValueValuePair<K, V>>();
        while (pairEnum.hasMoreElements()) {
            //@ assume pairEnum.moreElements;
            JMLValueValuePair<K, V> p = pairEnum.nextPair();
    ...
    /*@ public normal_behavior
      ...
      @                \result.has(
      @                    new JMLValueValuePair<K, JMLValueSet<V>>(dv, elementImage(dv))));
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> imagePairSet() {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueToValueRelationImageEnumerator<K, V> imagePairs() {
        return new JMLValueToValueRelationImageEnumerator<K, V>(this);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSetEnumerator<K> domainElements()
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSetEnumerator<V> rangeElements()
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueToValueMap<K, V> toFunction()
    {
        JMLValueSet<K> newDom = domain_;
        int newSize = domain_.int_size();

        JMLValueSet<JMLValueValuePair<K, JMLValueSet<V>>> newImagePairSet = imagePairSet_;
        ...
        if (newSize != size_) {
            ...
            while (imagePairEnum.hasMoreElements()) {
                ...
                img = new JMLValueSet<V>(o);
                newImagePairSet
                    = newImagePairSet
                    .insert(new JMLValueValuePair<K, JMLValueSet<V>>(imagePair.key, img));
            }
        }
        return new JMLValueToValueMap<K, V>(newImagePairSet, newDom, newSize);
    } //@ nowarn Exception;
}
