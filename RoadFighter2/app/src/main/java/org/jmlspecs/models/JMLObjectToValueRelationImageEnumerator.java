...
/*@ nullable_by_default @*/ 
public class JMLObjectToValueRelationImageEnumerator<K, V extends JMLType>
    implements JMLEnumeration<JMLObjectValuePair<K, JMLValueSet<V>>>, JMLValueType {

    //@ public model JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> uniteratedImagePairs;     in objectState;

    /** An enumerator for the image pairs in this relation.
     */
    protected /*@ non_null @*/ JMLValueSetEnumerator<JMLObjectValuePair<K, JMLValueSet<V>>> pairEnum;
    ...
    //@ public invariant elementType == \type(JMLObjectValuePair<K, JMLValueSet<V>>);
    ...
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLObjectValuePair<K, JMLValueSet<V>>);
    ...
    protected
        JMLObjectToValueRelationImageEnumerator(/*@ non_null @*/
                                                   JMLValueSetEnumerator<JMLObjectValuePair<K, JMLValueSet<V>>> pEnum)
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLObjectValuePair);
        //@ set returnsNull = false;
        pairEnum =  (JMLValueSetEnumerator<JMLObjectValuePair<K, JMLValueSet<V>>>)pEnum.clone();
    }
    ...
    public JMLObjectValuePair<K, JMLValueSet<V>> nextElement() throws JMLNoSuchElementException {
        if (pairEnum.hasMoreElements()) {
            JMLObjectValuePair<K, JMLValueSet<V>> o = pairEnum.nextElement();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLObjectValuePair<K, JMLValueSet<V>> nextImagePair()
        throws JMLNoSuchElementException {
        //@ assume moreElements;
        JMLObjectValuePair<K, JMLValueSet<V>> p = nextElement();
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectToValueRelationImageEnumerator<K, V>(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLObjectToValueRelationImageEnumerator<K, V> js
                = (JMLObjectToValueRelationImageEnumerator<K, V>) oth;
    ...
    protected /*@ spec_public pure @*/ /*@ non_null @*/
        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> abstractValue()
    {
        JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>> ret = new JMLValueSet<JMLObjectValuePair<K, JMLValueSet<V>>>();
        JMLObjectToValueRelationImageEnumerator<K, V> enum2
            = (JMLObjectToValueRelationImageEnumerator<K, V>) clone();
        while (enum2.hasMoreElements()) {
            JMLObjectValuePair<K, JMLValueSet<V>> aPair = enum2.nextImagePair();
