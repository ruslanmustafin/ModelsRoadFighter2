...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLValueSequence<E extends JMLType>
    extends JMLValueSequenceSpecs<E> implements JMLCollection<E>
{

    //*********************** equational theory ***********************

    /*@ public invariant (\forall JMLValueSequence<E> s2;
      @                    (\forall _E e1, e2;
      @                     (\forall \bigint n;
    ...
    /*@ public normal_behavior
      ...
      @ 
      @    ensures \result <==> !(new JMLValueSequence<E>()).has(e1);
      @  also
      @    ensures \result <==> (new JMLValueSequence<E>()).size() == 0;
      @  also
      @    ensures \result <==> (new JMLValueSequence<E>(e1)).size() == 1;
      @  also
      @    ensures \result <==> 
      @        e1 != null ==>
      @        (new JMLValueSequence<E>(e1)).itemAt(0).equals(e1);
      @  also
      @    ensures \result <==>
      @        e1 != null ==>
      ...
      @ also
      @   ensures \result <==>
      @      (new JMLValueSequence<E>(e1)).equals(
      @                  new JMLValueSequence<E>().insertFront(e1));
      @ also
      @   ensures \result <==>
      @      (new JMLValueSequence<E>(e1)).equals(
      @                  new JMLValueSequence<E>().insertBack(e1));
      @ also
      @   ensures \result <==>
      @      (new JMLValueSequence<E>(e1)).equals(
      @                  new JMLValueSequence<E>().insertAfterIndex(-1, e1));
      @ also
      @   ensures \result <==>
      @      (new JMLValueSequence<E>(e1)).equals(
      @                  new JMLValueSequence<E>().insertBeforeIndex(0, e1));
      @ also
      @   ensures \result <==>
      ...
      @ implies_that   
      @  ensures \result <==> (new JMLValueSequence<E>()).isEmpty();
      public pure model boolean equational_theory(JMLValueSequence<E> s,
                                                  JMLValueSequence<E> s2,
                                                  E e1,
                                                  E e2, \bigint n);
      @*/
    ...
    /*@
    model protected JMLValueSequence (JMLListValueNode<E> ls, \bigint len) {
        //@ set owner = null;
        theSeq = ls;	
    ...
    //@    ensures ls == null ==> !containsNull;
    protected JMLValueSequence (JMLListValueNode<E> ls, int len) {
        //@ set owner = null;
        theSeq = ls;	
     ...
     *  @see #JMLValueSequence(F)
     */
    /*@ public normal_behavior
      @    assignable \nothing;
      @    ensures \result != null && \result.equals(new JMLValueSequence<F>(e));
      @*/
    public static <F extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueSequence<F> singleton(F e)
    {
        return new JMLValueSequence<F>(e);
    }
    ...
    /*@ public normal_behavior
      ...
      @*/
    public static <F extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueSequence<F> convertFrom(/*@ non_null @*/F[] a)
    {
        /*@ non_null @*/ JMLValueSequence<F> ret = EMPTY;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public static <F extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueSequence<F> convertFrom(/*@ non_null @*/F[] a, int size)
    {
        /*@ non_null @*/ JMLValueSequence<F> ret = EMPTY;
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static <F extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueSequence<F> convertFrom(/*@ non_null @*/ java.util.Collection<F> c)
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static <F extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLValueSequence<F> convertFrom(/*@ non_null @*/ JMLCollection<F> c)
        throws ClassCastException
    {
        /*@ non_null @*/ JMLValueSequence<F> ret = EMPTY;
    ...
    model public E itemAt(\bigint i) throws JMLSequenceException {
        if (i < 0 || i >= this.length) {
            ...
            JMLListValueNode<E> thisWalker = theSeq;
    ...
    model public \bigint bi_count(JMLType item) {
        JMLListValueNode<E> ptr = this.theSeq;
        \bigint cnt = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isPrefix(/*@ non_null @*/ JMLValueSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isProperPrefix(/*@ non_null @*/ JMLValueSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is true *);
      @*/
    public boolean isSuffix(/*@ non_null @*/ JMLValueSequence<E> s2) {
        ...
        JMLListValueNode<E> suffix = s2.theSeq.removePrefix(s2.int_length() - int_length());
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isProperSuffix(/*@ non_null @*/ JMLValueSequence<E> s2) {
    ...
    /*@ also
      ...
      @     ensures \result <==>
      @          isPrefix((JMLValueSequence<E>)obj)
      @          && ((JMLValueSequence<E>)obj).isPrefix(this);
      @     ensures_redundantly \result ==>
      @          containsNull == ((JMLValueSequence<E>)obj).containsNull;
      @ also
      @  public normal_behavior
      @    requires obj == null || !(obj instanceof JMLValueSequence);
      @    ensures !\result;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object obj) {
        return (obj != null && obj instanceof JMLValueSequence)
            && (int_length() == ((JMLValueSequence<E>)obj).int_length())
            && isPrefix((JMLValueSequence<E>)obj);
    }  
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isSubsequence(/*@ non_null @*/ JMLValueSequence<E> s2) {
        JMLListValueNode<E> walker = s2.theSeq;
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isProperSubsequence(/*@ non_null @*/ JMLValueSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isSupersequence(/*@ non_null @*/ JMLValueSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isProperSupersequence(/*@ non_null @*/ JMLValueSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isInsertionInto(/*@ non_null @*/ JMLValueSequence<E> s2,
                                   E elem) {
        if (int_length() != s2.int_length() + 1) {
            return false;
        }
        JMLListValueNode<E> walker = theSeq;
        JMLListValueNode<E> s2walker = s2.theSeq;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isDeletionFrom(/*@ non_null @*/ JMLValueSequence<E> s2,
                                  E elem) {
    ...
    /*@ also
      ...
      @        && ((JMLValueSequence<E>)\result).equals(this);
      @*/
    ...
    /*@ model public JMLValueSequence prefix(\bigint n) //FIXME, non_null
        ...
        if (n < 0 || n > length) {
            ...
            if (n == 0) {
                ...
                JMLListValueNode<E> pfx_list = theSeq.prefix(n);
                assume pfx_list != null;
                assume !containsNull ==> !pfx_list.containsNull;
                return new JMLValueSequence<E>(pfx_list, n);
            }
        }
    }  
    @*/
    ...
    /*@  public normal_behavior
      ...
      @     ensures \result.equals(this);
      @*/
      public /*@ non_null @*/ JMLValueSequence<E> prefix(int n)
	  throws JMLSequenceException {
	  if (n < 0 || n > int_length()) {
	      throw new
		  JMLSequenceException("Invalid parameter to prefix() with n = " 
    ...
    /*@
      ...
      @*/
    /*@
      model public JMLValueSequence<E> removePrefix(\bigint n) //FIXME,  @non_null@
        throws JMLSequenceException {
        if (n < 0 || n > length) {
            throw new
            ...
            if (n == 0) {
                ...
                JMLListValueNode<E> pfx_list = theSeq.removePrefix(n);
    ...
    /*@
      ...
      @     ensures \result.isEmpty();
      @*/
    public /*@ non_null @*/ JMLValueSequence<E> removePrefix(int n)
        throws JMLSequenceException {
        if (n < 0 || n > int_length()) {
            throw new
                JMLSequenceException("Invalid parameter to removePrefix() "
            ...
            if (n == 0) {
                ...
                /*@ assume pfx_list == null <==> n == length;
                  ...
                  @*/
                return new JMLValueSequence<E>(pfx_list, int_length()-n);
            }
        }
    }  
    ...
    /*@
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSequence<E> concat(/*@ non_null @*/ JMLValueSequence<E> s2) {
        if (theSeq == null) {
            return s2;
        } else if (s2.theSeq == null) {
            return this;
        } else {
            JMLListValueNode<E> new_list = theSeq.concat(s2.theSeq);
            /*@ assume new_list != null && int_length() + s2.int_length() > 0;
              @*/
            return new JMLValueSequence<E>(new_list,
                                         int_length() + s2.int_length());
        }
    }  //@ nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @    ensures containsNull <==> \result.containsNull;
      @*/
    public /*@ non_null @*/ JMLValueSequence<E> reverse() {
        if (theSeq == null) {
            return this;
        } else {
            JMLListValueNode<E> r = theSeq.reverse();
            return new JMLValueSequence<E>(r, int_length());
        }
    } //@ nowarn Post;
    ...
    model public  non_null  JMLValueSequence removeItemAt(\bigint index)
        ...
        if (0 <= index && index < length()) {
            JMLListValueNode<E> new_list = theSeq.removeItemAt(index);
             assume new_list == null <==> int_length() == 1;
             assume !containsNull && new_list != null
                ==> !new_list.containsNull;
            
            return new JMLValueSequence<E>(new_list, length()-1);
        } else {
            throw new
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is <a,b,c,d> *);
      @*/
    public /*@ non_null @*/ JMLValueSequence<E> removeItemAt(int index)
        throws JMLSequenceException {
        if (0 <= index && index < int_length()) {
            ...
            /*@ assume new_list == null <==> int_length() == 1;
              ...
              @    ==> !new_list.containsNull;
              @*/
            return new JMLValueSequence<E>(new_list, int_length()-1);
        } else {
            throw new
                JMLSequenceException("Invalid parameter to removeItemAt() "
                                     + "with index = " + index + "\n"
    ...
    /*@
      ...
      @*/
    /*@
    model public  non_null  JMLValueSequence<E>
        replaceItemAt(\bigint index, JMLType item)
        throws JMLSequenceException {
        if (0 <= index && index < length()) {
            // replaceItemAt() clones item, if necessary
            JMLListValueNode<E> new_list = theSeq.replaceItemAt(index, item);
             assume new_list == null <==> length() == 0;
            return new JMLValueSequence<E>(new_list, length());
        } else {
            throw new
    ...
    /*@
      ...
      @     ensures (* \result is <a,x,c,d,e> *);
      @*/
    public /*@ non_null @*/ JMLValueSequence<E> replaceItemAt(int index, E item)
        throws JMLSequenceException {
        if (0 <= index && index < int_length()) {
            // replaceItemAt() clones item, if necessary
            JMLListValueNode<E> new_list = theSeq.replaceItemAt(index, item);
            //@ assume new_list == null <==> int_length() == 0;
            return new JMLValueSequence<E>(new_list, int_length());
        } else {
            throw new
                JMLSequenceException("Invalid parameter to replaceItemAt() "
                                     + "with index = " + index + "\n"
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is <a,b,c> *);
      @*/
    public /*@ non_null @*/ JMLValueSequence<E> header()
        throws JMLSequenceException {
        if (theSeq == null) {
            throw new JMLSequenceException("Tried header() on empty sequence.");
        } else {
            JMLListValueNode<E> new_list = theSeq.removeLast();
            //@ assume new_list == null <==> int_length() == 1;
            return new JMLValueSequence<E>(new_list, int_length() - 1);
        }   
    } //@ nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ /*@ non_null @*/ JMLValueSequence<E> trailer()
        throws JMLSequenceException {
        if (theSeq == null) {
            throw new JMLSequenceException("Tried trailer() on empty sequence.");
        } else {
            JMLListValueNode<E> new_list = theSeq.next;
            //@ assume new_list == null <==> int_length() == 1;
    ...
    /*@ //FIXME, _ alsoIfValue _
      ...
      @*/
    /*@
    model public non_null JMLValueSequence<E> insertAfterIndex(\bigint afterThisOne,
    ...
    /*@ also
      ...
      @     ensures (* \result is <d,a,b,c> *);
      @*/
    public /*@ non_null @*/ JMLValueSequence<E> insertAfterIndex(int afterThisOne,
                                                             E item)
        throws JMLSequenceException, IllegalStateException
    {
    ...
    /*@ //FIXME, _ alsoIfValue _
      ...
      @                  concat(new JMLValueSequence<E>(item)).
    ...
    /*@ 
      model public  
        non_null JMLValueSequence<E> insertBeforeIndex(\bigint beforeThisOne, E item)
        throws JMLSequenceException, IllegalStateException //FIXME, _ nonNullIfObj _
    {
	  ...
	  return new JMLValueSequence<E>(item);
	} else {
	  // insertBefore() clones item, if necessary
	  JMLListValueNode<E> new_list
    ...
    /*@ also
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSequence<E> insertBeforeIndex(int beforeThisOne, E item)
        throws JMLSequenceException, IllegalStateException
    {
    ...
    /*@ also
      ...
      @     ensures (* \result is <a,b,c,d> *);
      @*/
    public /*@ non_null @*/ JMLValueSequence<E> insertBack(E item)
        throws IllegalStateException
    {
        if (theSeq == null) {
            ...
            return new JMLValueSequence<E>(theSeq.append(item), int_length()+1);
        } else {
            throw new IllegalStateException(TOO_BIG_TO_INSERT);
        }
    }
    ...
    /*@ also
      ...
      @     ensures (* \result is <d,a,b,c> *);
      @*/
    public /*@ pure @*/ /*@ non_null @*/ JMLValueSequence<E> insertFront(E item)
        throws IllegalStateException
    {
        if (theSeq == null) {
            return new JMLValueSequence<E>(item);
        } else if (int_length() < Integer.MAX_VALUE) {
            return new JMLValueSequence<E>(  // cons() clones item, if necessary
    ...
    /*@  public normal_behavior
      ...
      @*/
    /*@
    model public  non_null  JMLValueSequence<E> subsequence(\bigint from, \bigint to)
        throws JMLSequenceException {
        if (from < 0 || from > to || to > length()) {
            ...
            if (theSeq == null) {
                ...
                JMLListValueNode<E> removedPrefix = theSeq.removePrefix(from);
                if (removedPrefix == null) {
                     assert from == length() && from == to;
                    return new JMLValueSequence<E>();
                } else {
                    JMLListValueNode<E> new_list = removedPrefix.prefix(to-from);
                     assume new_list == null <==> to == from;
                    return new JMLValueSequence<E>(new_list, to - from);
                }
            }
        }
    }  nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @     ensures \result.isEmpty();
      @*/
    public /*@ non_null @*/ JMLValueSequence<E> subsequence(int from, int to)
        throws JMLSequenceException {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSequenceEnumerator<E> elements() {
        JMLValueSequenceEnumerator<E> retValue 
            = new JMLValueSequenceEnumerator<E>(this);
        return retValue;
    }  
    ...
    public /*@ non_null @*/ String toString() {
        String newStr = "(<";
        JMLListValueNode<E> seqWalker = theSeq;
        boolean first = true;
