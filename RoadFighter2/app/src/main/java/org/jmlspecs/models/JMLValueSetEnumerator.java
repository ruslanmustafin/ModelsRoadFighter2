...
/*@ nullable_by_default @*/ 
public class JMLValueSetEnumerator<E extends JMLType>
    implements JMLEnumeration<E>, JMLValueType
{

    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLValueSet<E> uniteratedElems;        in objectState;
    ...
    //@ protected represents uniteratedElems <- new JMLValueSet<E>(currentNode);
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLValueSetEnumerator(/*@ non_null @*/ JMLValueSet<E> s) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLValueSetEnumerator<E>(new JMLValueSet<E>(currentNode));
    } //@ nowarn Post;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLValueSetEnumerator)) {
            ...
            JMLValueSetEnumerator<E> js = (JMLValueSetEnumerator<E>) oth;
            if (currentNode == null) {
