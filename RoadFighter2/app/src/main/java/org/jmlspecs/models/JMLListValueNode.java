...
/*@ nullable_by_default @*/ 
/*@ pure spec_public @*/ class JMLListValueNode<E extends JMLType> implements JMLValueType {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLListValueNode(E item, JMLListValueNode<E> nxt) {
        //@ set owner = null;
        val = item;
        next = nxt;
        /*@ set elementType
    ...
    /*@  public normal_behavior
      ...
      @*/
    public static <F extends JMLType> /*@ pure @*/
        JMLListValueNode<F> cons(/*@ nullable @*/ F hd, /*@ nullable @*/ JMLListValueNode<F> tl) {
        if (hd == null) {
            JMLListValueNode<F> ret = new JMLListValueNode<F>(null, tl);
            //@ assume ret.containsNull;
            return ret;
        } else {
            F h = (F)hd.clone();
            //@ assume h != null && h instanceof JMLType;
            JMLListValueNode<F> ret = new JMLListValueNode<F>((F)h, tl);
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean headEquals(E item) {
        return elem_equals(val, item);
    }

    /** Tell if the given elements are equal, taking null into account.
     */
    private static <F extends JMLType> /*@ pure @*/ boolean elem_equals(F item1,
                                                      F item2) {
    ...
    /*@  public normal_behavior
      ...
      @    ensures !\result;
      @*/
    public boolean isPrefixOf(JMLListValueNode<E> ls2) {
        if (ls2 == null) {
            return false;
        }
        JMLListValueNode<E> othLst = ls2;
        JMLListValueNode<E> thisLst = this;
        /*@ maintaining
    ...
    public boolean equals(/*@ nullable @*/ Object ls2) {
        if (ls2 != null && ls2 instanceof JMLListValueNode) {
            JMLListValueNode<E> othLst = (JMLListValueNode<E>)ls2;
            JMLListValueNode<E> thisLst = this;
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull ==> \result != null;
      @*/
    public E getItem(E item) throws JMLListException {
        JMLListValueNode<E> ptr = this;
        //@ maintaining (* no earlier element is elem_equals to item *);
        while (ptr != null) {
            if (elem_equals(ptr.val, item)) {
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListValueNode<E> prefix(int n) {
        return (n <= 0 
                ? null 
                : new JMLListValueNode<E>(val, 
                                        (next == null ? null 
                                         : next.prefix(n-1)))
                );
    }
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListValueNode<E> removePrefix(int n) {
        return (n <= 0 
                ? this
                : (next == null ? null : next.removePrefix(n-1))
                );
    ...
    /*@  public normal_behavior
      ...
      @    ensures !containsNull && \result != null ==> !\result.containsNull;
      @*/
    public JMLListValueNode<E> removeItemAt(int n) {
        return (n <= 0 
                ? next
                : (next == null ? null 
                   : new JMLListValueNode<E>(val, next.removeItemAt(n-1)))
                );
    }
    ...
    /*@  public normal_behavior
      ...
      @            ==> !\result.containsNull;
      @*/
    public JMLListValueNode<E> replaceItemAt(int n, E item) {
        return (n <= 0 
                ? cons(item, next) // cons() handles any necessary cloning
                : (next == null ? null 
                   : new JMLListValueNode<E>(val, 
    ...
    public JMLListValueNode<E> removeLast() {
        return (next == null 
                ? null 
                : new JMLListValueNode<E>(val, next.removeLast()));
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLListValueNode<E> concat(/*@ non_null @*/ JMLListValueNode<E> ls2)
    {
        return (next == null
                ? new JMLListValueNode<E>(val, ls2)
                : new JMLListValueNode<E>(val, next.concat(ls2))
                );
    }
    ...
    /*@  public normal_behavior
      ...
      @         && \result.int_length() == int_length() + 1;
      @*/
    public /*@ non_null @*/ JMLListValueNode<E> prepend(E item) {
    ...
    /*@  public normal_behavior
      ...
      @         && \result.int_length() == int_length() + 1;
      @*/
    public /*@ non_null @*/ JMLListValueNode<E> append(E item) {
        ...
        JMLListValueNode<E> ptr = this;
        JMLListValueNode<E> revret = null;
        //@ maintaining (* reverse(revret) concatenated with ptr equals this *);
        while (ptr != null) {
            revret = new JMLListValueNode<E>(ptr.val, revret); // don't clone yet
            ptr = ptr.next;
        }
        return (new JMLListValueNode<E>(item, revret)).reverse();
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLListValueNode<E> reverse() {
        JMLListValueNode<E> ptr = this;
        JMLListValueNode<E> ret = null;
        //@ loop_invariant ptr != this ==> ret != null;
        //@ maintaining (* ret is the reverse of items in this up to ptr *);
        while (ptr != null) {
            //@ assume ptr.val != null ==> \typeof(ptr.val) <: elementType;
            ret = new JMLListValueNode<E>(ptr.val == null ? null
                                        : (E)(ptr.val).clone(),
                                        ret);
            ptr = ptr.next;
        }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLListValueNode<E> insertBefore(int n, E item) 
        throws JMLListException {
        if ( n < 0 || (n > 1 && next == null) ) {
            throw new JMLListException("Index to insertBefore out of range.");
        } else if (n == 0) {
            ...
            //@ assert n > 0;
            return new JMLListValueNode<E>(val,
                                         (next == null
                                          ? cons(item, null)
                                          : next.insertBefore(n-1, item)));
        }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLListValueNode<E> remove(E item) {
        if (item == null) {
            if (val == null) {
                return next;
            } else {
