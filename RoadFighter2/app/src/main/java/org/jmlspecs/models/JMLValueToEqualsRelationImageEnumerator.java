...
/*@ nullable_by_default @*/ 
public class JMLValueToEqualsRelationImageEnumerator<K extends JMLType, V>
    implements JMLEnumeration<JMLValueValuePair<K, JMLEqualsSet<V>>>, JMLValueType {

    //@ public model JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> uniteratedImagePairs;     in objectState;

    /** An enumerator for the image pairs in this relation.
     */
    protected /*@ non_null @*/ JMLValueSetEnumerator<JMLValueValuePair<K, JMLEqualsSet<V>>> pairEnum;
    ...
    //@ public invariant elementType == \type(JMLValueValuePair<K, JMLEqualsSet<V>>);
    ...
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLValueValuePair<K, JMLEqualsSet<V>>);
    ...
    protected
        JMLValueToEqualsRelationImageEnumerator(/*@ non_null @*/
                                                   JMLValueSetEnumerator<JMLValueValuePair<K, JMLEqualsSet<V>>> pEnum)
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLValueValuePair);
        //@ set returnsNull = false;
        pairEnum =  (JMLValueSetEnumerator<JMLValueValuePair<K, JMLEqualsSet<V>>>)pEnum.clone();
    }
    ...
    /*@ also
      ...
      @*/
    public JMLValueValuePair<K, JMLEqualsSet<V>> nextElement() throws JMLNoSuchElementException {
        if (pairEnum.hasMoreElements()) {
            JMLValueValuePair<K, JMLEqualsSet<V>> o = pairEnum.nextElement();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueValuePair<K, JMLEqualsSet<V>> nextImagePair()
        throws JMLNoSuchElementException {
        //@ assume moreElements;
        JMLValueValuePair<K, JMLEqualsSet<V>> p = nextElement();
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLValueToEqualsRelationImageEnumerator<K, V>(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLValueToEqualsRelationImageEnumerator<K, V> js
                = (JMLValueToEqualsRelationImageEnumerator<K, V>) oth;
    ...
    protected /*@ spec_public pure @*/ /*@ non_null @*/
        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> abstractValue()
    {
        JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>> ret = new JMLValueSet<JMLValueValuePair<K, JMLEqualsSet<V>>>();
        JMLValueToEqualsRelationImageEnumerator<K, V> enum2
            = (JMLValueToEqualsRelationImageEnumerator<K, V>) clone();
        while (enum2.hasMoreElements()) {
            JMLValueValuePair<K, JMLEqualsSet<V>> aPair = enum2.nextImagePair();
