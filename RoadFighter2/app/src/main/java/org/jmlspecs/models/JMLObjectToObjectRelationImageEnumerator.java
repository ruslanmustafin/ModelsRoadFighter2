...
/*@ nullable_by_default @*/ 
public class JMLObjectToObjectRelationImageEnumerator<K, V>
    implements JMLEnumeration<JMLObjectValuePair<K, JMLObjectSet<V>>>, JMLValueType {

    //@ public model JMLValueSet<JMLObjectValuePair<K, JMLObjectSet<V>>> uniteratedImagePairs;     in objectState;

    /** An enumerator for the image pairs in this relation.
     */
    protected /*@ non_null @*/ JMLValueSetEnumerator<JMLObjectValuePair<K, JMLObjectSet<V>>> pairEnum;
    ...
    //@ public invariant elementType == \type(JMLObjectValuePair<K, JMLObjectSet<V>>);
    ...
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLObjectValuePair<K, JMLObjectSet<V>>);
    ...
    protected
        JMLObjectToObjectRelationImageEnumerator(/*@ non_null @*/
                                                   JMLValueSetEnumerator<JMLObjectValuePair<K, JMLObjectSet<V>>> pEnum)
    {
        //@ set owner = null;
        //@ set elementType = \type(JMLObjectValuePair);
        //@ set returnsNull = false;
        pairEnum =  (JMLValueSetEnumerator<JMLObjectValuePair<K, JMLObjectSet<V>>>)pEnum.clone();
    }
    ...
    /*@ also
      ...
      @*/
    public JMLObjectValuePair<K, JMLObjectSet<V>> nextElement() throws JMLNoSuchElementException {
        if (pairEnum.hasMoreElements()) {
            JMLObjectValuePair<K, JMLObjectSet<V>> o = pairEnum.nextElement();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLObjectValuePair<K, JMLObjectSet<V>> nextImagePair()
        throws JMLNoSuchElementException {
        //@ assume moreElements;
        JMLObjectValuePair<K, JMLObjectSet<V>> p = nextElement();
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectToObjectRelationImageEnumerator<K, V>(pairEnum);
    } //@ nowarn Post; 
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null
            ...
            JMLObjectToObjectRelationImageEnumerator<K, V> js
                = (JMLObjectToObjectRelationImageEnumerator<K, V>) oth;
    ...
    protected /*@ spec_public pure @*/ /*@ non_null @*/
        JMLValueSet<JMLObjectValuePair<K, JMLObjectSet<V>>> abstractValue()
    {
        JMLValueSet<JMLObjectValuePair<K, JMLObjectSet<V>>> ret = new JMLValueSet<JMLObjectValuePair<K, JMLObjectSet<V>>>();
        JMLObjectToObjectRelationImageEnumerator<K, V> enum2
            = (JMLObjectToObjectRelationImageEnumerator<K, V>) clone();
        while (enum2.hasMoreElements()) {
            JMLObjectValuePair<K, JMLObjectSet<V>> aPair = enum2.nextImagePair();
