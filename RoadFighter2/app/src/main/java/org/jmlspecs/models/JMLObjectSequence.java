...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLObjectSequence<E>
    implements JMLCollection<E>
{

    //*********************** equational theory ***********************

    /*@ public invariant (\forall JMLObjectSequence<E> s2;
      @                    (\forall _E e1, e2;
      @                     (\forall \bigint n;
    ...
    /*@ public normal_behavior
      ...
      @ 
      @    ensures \result <==> !(new JMLObjectSequence<E>()).has(e1);
      @  also
      @    ensures \result <==> (new JMLObjectSequence<E>()).size() == 0;
      @  also
      @    ensures \result <==> (new JMLObjectSequence<E>(e1)).size() == 1;
      @  also
      @    ensures \result <==> 
      @        e1 != null ==>
      @        (new JMLObjectSequence<E>(e1)).itemAt(0) == e1;
      @  also
      @    ensures \result <==>
      @        e1 != null ==>
      ...
      @ also
      @   ensures \result <==>
      @      (new JMLObjectSequence<E>(e1)).equals(
      @                  new JMLObjectSequence<E>().insertFront(e1));
      @ also
      @   ensures \result <==>
      @      (new JMLObjectSequence<E>(e1)).equals(
      @                  new JMLObjectSequence<E>().insertBack(e1));
      @ also
      @   ensures \result <==>
      @      (new JMLObjectSequence<E>(e1)).equals(
      @                  new JMLObjectSequence<E>().insertAfterIndex(-1, e1));
      @ also
      @   ensures \result <==>
      @      (new JMLObjectSequence<E>(e1)).equals(
      @                  new JMLObjectSequence<E>().insertBeforeIndex(0, e1));
      @ also
      @   ensures \result <==>
      ...
      @ implies_that   
      @  ensures \result <==> (new JMLObjectSequence<E>()).isEmpty();
      public pure model boolean equational_theory(JMLObjectSequence<E> s,
                                                  JMLObjectSequence<E> s2,
                                                  E e1,
                                                  E e2, \bigint n);
      @*/
    ...
    /*@
    model protected JMLObjectSequence (JMLListObjectNode<E> ls, \bigint len) {
        //@ set owner = null;
        theSeq = ls;	
     ...
     *  @see #JMLObjectSequence(F)
     */
    /*@ public normal_behavior
      @    assignable \nothing;
      @    ensures \result != null && \result.equals(new JMLObjectSequence<F>(e));
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLObjectSequence<F> singleton(F e)
    {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLObjectSequence<F> convertFrom(/*@ non_null @*/F[] a)
    {
        /*@ non_null @*/ JMLObjectSequence<F> ret = EMPTY;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLObjectSequence<F> convertFrom(/*@ non_null @*/F[] a, int size)
    {
        /*@ non_null @*/ JMLObjectSequence<F> ret = EMPTY;
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLObjectSequence<F> convertFrom(/*@ non_null @*/ java.util.Collection<F> c)
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLObjectSequence<F> convertFrom(/*@ non_null @*/ JMLCollection<F> c)
        throws ClassCastException
    {
        /*@ non_null @*/ JMLObjectSequence<F> ret = EMPTY;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isPrefix(/*@ non_null @*/ JMLObjectSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isProperPrefix(/*@ non_null @*/ JMLObjectSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is true *);
      @*/
    public boolean isSuffix(/*@ non_null @*/ JMLObjectSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isProperSuffix(/*@ non_null @*/ JMLObjectSequence<E> s2) {
    ...
    /*@ also
      ...
      @     ensures \result <==>
      @          isPrefix((JMLObjectSequence<E>)obj)
      @          && ((JMLObjectSequence<E>)obj).isPrefix(this);
      @     ensures_redundantly \result ==>
      @          containsNull == ((JMLObjectSequence<E>)obj).containsNull;
      @ also
      @  public normal_behavior
      @    requires obj == null || !(obj instanceof JMLObjectSequence);
      @    ensures !\result;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object obj) {
        return (obj != null && obj instanceof JMLObjectSequence)
            && (int_length() == ((JMLObjectSequence<E>)obj).int_length())
            && isPrefix((JMLObjectSequence<E>)obj);
    }  
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isSubsequence(/*@ non_null @*/ JMLObjectSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isProperSubsequence(/*@ non_null @*/ JMLObjectSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isSupersequence(/*@ non_null @*/ JMLObjectSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isProperSupersequence(/*@ non_null @*/ JMLObjectSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isInsertionInto(/*@ non_null @*/ JMLObjectSequence<E> s2,
                                   E elem) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isDeletionFrom(/*@ non_null @*/ JMLObjectSequence<E> s2,
                                  E elem) {
    ...
    /*@ also
      ...
      @        && ((JMLObjectSequence<E>)\result).equals(this);
      @*/
    ...
    /*@  public normal_behavior
      ...
      @     ensures \result.equals(this);
      @*/
      public /*@ non_null @*/ JMLObjectSequence<E> prefix(int n)
	  throws JMLSequenceException {
	  if (n < 0 || n > int_length()) {
	      throw new
		  JMLSequenceException("Invalid parameter to prefix() with n = " 
    ...
    /*@
      ...
      @*/
    /*@
      model public JMLObjectSequence<E> removePrefix(\bigint n) //FIXME,  @non_null@
        throws JMLSequenceException {
        if (n < 0 || n > length) {
            throw new
    ...
    /*@
      ...
      @     ensures \result.isEmpty();
      @*/
    public /*@ non_null @*/ JMLObjectSequence<E> removePrefix(int n)
        throws JMLSequenceException {
        if (n < 0 || n > int_length()) {
            throw new
                JMLSequenceException("Invalid parameter to removePrefix() "
    ...
    /*@
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectSequence<E> concat(/*@ non_null @*/ JMLObjectSequence<E> s2) {
        if (theSeq == null) {
            return s2;
            ...
            /*@ assume new_list != null && int_length() + s2.int_length() > 0;
              @*/
            return new JMLObjectSequence<E>(new_list,
                                         int_length() + s2.int_length());
        }
    }  //@ nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @    ensures containsNull <==> \result.containsNull;
      @*/
    public /*@ non_null @*/ JMLObjectSequence<E> reverse() {
        if (theSeq == null) {
            return this;
        } else {
    ...
    model public  non_null  JMLObjectSequence removeItemAt(\bigint index)
        ...
        if (0 <= index && index < length()) {
            ...
            return new JMLObjectSequence<E>(new_list, length()-1);
        } else {
            throw new
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is <a,b,c,d> *);
      @*/
    public /*@ non_null @*/ JMLObjectSequence<E> removeItemAt(int index)
        throws JMLSequenceException {
    ...
    /*@
      ...
      @*/
    /*@
    model public  non_null  JMLObjectSequence<E>
        ...
        if (0 <= index && index < length()) {
            ...
            return new JMLObjectSequence<E>(new_list, length());
        } else {
            throw new
    ...
    /*@
      ...
      @     ensures (* \result is <a,x,c,d,e> *);
      @*/
    public /*@ non_null @*/ JMLObjectSequence<E> replaceItemAt(int index, E item)
        throws JMLSequenceException {
        if (0 <= index && index < int_length()) {
            // replaceItemAt() clones item, if necessary
            JMLListObjectNode<E> new_list = theSeq.replaceItemAt(index, item);
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is <a,b,c> *);
      @*/
    public /*@ non_null @*/ JMLObjectSequence<E> header()
        throws JMLSequenceException {
        if (theSeq == null) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ /*@ non_null @*/ JMLObjectSequence<E> trailer()
        throws JMLSequenceException {
        if (theSeq == null) {
    ...
    /*@ //FIXME, _ alsoIfValue _
      ...
      @*/
    /*@
    model public non_null JMLObjectSequence<E> insertAfterIndex(\bigint afterThisOne,
    ...
    /*@ 
      ...
      @     ensures (* \result is <d,a,b,c> *);
      @*/
    public /*@ non_null @*/ JMLObjectSequence<E> insertAfterIndex(int afterThisOne,
                                                             E item)
        throws JMLSequenceException, IllegalStateException
    {
    ...
    /*@ //FIXME, _ alsoIfValue _
      ...
      @                  concat(new JMLObjectSequence<E>(item)).
    ...
    /*@ 
      model public  
        non_null JMLObjectSequence<E> insertBeforeIndex(\bigint beforeThisOne, E item)
    ...
    /*@ 
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectSequence<E> insertBeforeIndex(int beforeThisOne, E item)
        throws JMLSequenceException, IllegalStateException
    {
    ...
    /*@ 
      ...
      @     ensures (* \result is <a,b,c,d> *);
      @*/
    public /*@ non_null @*/ JMLObjectSequence<E> insertBack(E item)
    ...
    /*@ 
      ...
      @     ensures (* \result is <d,a,b,c> *);
      @*/
    public /*@ pure @*/ /*@ non_null @*/ JMLObjectSequence<E> insertFront(E item)
        throws IllegalStateException
    {
        if (theSeq == null) {
            return new JMLObjectSequence<E>(item);
        } else if (int_length() < Integer.MAX_VALUE) {
            return new JMLObjectSequence<E>(  // cons() clones item, if necessary
    ...
    /*@  public normal_behavior
      ...
      @*/
    /*@
    model public  non_null  JMLObjectSequence<E> subsequence(\bigint from, \bigint to)
        throws JMLSequenceException {
    ...
    /*@  public normal_behavior
      ...
      @     ensures \result.isEmpty();
      @*/
    public /*@ non_null @*/ JMLObjectSequence<E> subsequence(int from, int to)
        throws JMLSequenceException {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLObjectSequenceEnumerator<E> elements() {
        JMLObjectSequenceEnumerator<E> retValue 
            = new JMLObjectSequenceEnumerator<E>(this);
        return retValue;
    }  
