...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLObjectObjectPair<K, V> implements JMLType {
     ...
     */
    public /*@ extract @*/ JMLObjectObjectPair(/*@ non_null @*/ K dv,
                               /*@ non_null @*/ V rv)
    ...
    {
        return new JMLObjectObjectPair<K, V>(key, value);
    } //@ nowarn Post;
