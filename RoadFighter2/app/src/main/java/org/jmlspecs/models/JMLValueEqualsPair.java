...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLValueEqualsPair<K extends JMLType, V> implements JMLType {
     ...
     */
    public /*@ extract @*/ JMLValueEqualsPair(/*@ non_null @*/ K dv,
                               /*@ non_null @*/ V rv)
    ...
    {
        return new JMLValueEqualsPair<K, V>(key, value);
    } //@ nowarn Post;
