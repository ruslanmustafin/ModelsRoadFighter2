...
/*@ nullable_by_default @*/ 
public class JMLObjectBagEnumerator<E>
    implements JMLEnumeration<E>, JMLObjectType
{
    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLObjectBag<E> uniteratedElems;   in objectState;

    /** The bag underlying this enumerator.
     */
    protected /*@ non_null @*/ JMLObjectBag<E> currentBag;
    //@                                        in uniteratedElems;
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLObjectBagEnumerator(/*@ non_null @*/ JMLObjectBag<E> b) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLObjectBagEnumerator<E>(abstractValue());
    } //@ nowarn Post;

    /** Return the abstract value of this bag enumerator.
     */
    protected /*@ pure non_null @*/ JMLObjectBag<E> abstractValue() {
        JMLObjectBag<E> absVal = currentBag;
        if (currentCount > 0) {
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLObjectBagEnumerator)) {
            ...
            JMLObjectBagEnumerator<E> jb = (JMLObjectBagEnumerator<E>) oth;
