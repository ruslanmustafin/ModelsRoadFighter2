...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLValueValuePair<K extends JMLType, V extends JMLType> implements JMLValueType {
     ...
     */
    public /*@ extract @*/ JMLValueValuePair(/*@ non_null @*/ K dv,
                               /*@ non_null @*/ V rv)
    ...
    {
        return new JMLValueValuePair<K, V>(key, value);
    } //@ nowarn Post;
