...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLEqualsSequence<E>
    implements JMLCollection<E>
{

    //*********************** equational theory ***********************

    /*@ public invariant (\forall JMLEqualsSequence<E> s2;
      @                    (\forall _E e1, e2;
      @                     (\forall \bigint n;
    ...
    /*@ public normal_behavior
      ...
      @ 
      @    ensures \result <==> !(new JMLEqualsSequence<E>()).has(e1);
      @  also
      @    ensures \result <==> (new JMLEqualsSequence<E>()).size() == 0;
      @  also
      @    ensures \result <==> (new JMLEqualsSequence<E>(e1)).size() == 1;
      @  also
      @    ensures \result <==> 
      @        e1 != null ==>
      @        (new JMLEqualsSequence<E>(e1)).itemAt(0).equals(e1);
      @  also
      @    ensures \result <==>
      @        e1 != null ==>
      ...
      @ also
      @   ensures \result <==>
      @      (new JMLEqualsSequence<E>(e1)).equals(
      @                  new JMLEqualsSequence<E>().insertFront(e1));
      @ also
      @   ensures \result <==>
      @      (new JMLEqualsSequence<E>(e1)).equals(
      @                  new JMLEqualsSequence<E>().insertBack(e1));
      @ also
      @   ensures \result <==>
      @      (new JMLEqualsSequence<E>(e1)).equals(
      @                  new JMLEqualsSequence<E>().insertAfterIndex(-1, e1));
      @ also
      @   ensures \result <==>
      @      (new JMLEqualsSequence<E>(e1)).equals(
      @                  new JMLEqualsSequence<E>().insertBeforeIndex(0, e1));
      @ also
      @   ensures \result <==>
      ...
      @ implies_that   
      @  ensures \result <==> (new JMLEqualsSequence<E>()).isEmpty();
      public pure model boolean equational_theory(JMLEqualsSequence<E> s,
                                                  JMLEqualsSequence<E> s2,
                                                  E e1,
                                                  E e2, \bigint n);
      @*/
     ...
     */
    protected final JMLListEqualsNode<E> theSeq;
    //@                                 in objectState;
          ...
          @*/
    {
        ...
        //@ set elementType = (e == null ? \type(E) : \typeof(e));
    ...
    /*@
    model protected JMLEqualsSequence (JMLListEqualsNode<E> ls, \bigint len) {
        //@ set owner = null;
        theSeq = ls;	
    ...
    //@    ensures ls == null ==> !containsNull;
    protected JMLEqualsSequence (JMLListEqualsNode<E> ls, int len) {
        //@ set owner = null;
        theSeq = ls;	
     ...
     *  @see #JMLEqualsSequence(F)
     */
    /*@ public normal_behavior
      @    assignable \nothing;
      @    ensures \result != null && \result.equals(new JMLEqualsSequence<F>(e));
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSequence<F> singleton(F e)
    {
        return new JMLEqualsSequence<F>(e);
    }
    ...
    /*@ public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSequence<F> convertFrom(/*@ non_null @*/F[] a)
    {
        /*@ non_null @*/ JMLEqualsSequence<F> ret = EMPTY;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSequence<F> convertFrom(/*@ non_null @*/F[] a, int size)
    {
        /*@ non_null @*/ JMLEqualsSequence<F> ret = EMPTY;
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSequence<F> convertFrom(/*@ non_null @*/ java.util.Collection<F> c)
    ...
    /*@   public normal_behavior
      ...
      @*/
    public static <F> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsSequence<F> convertFrom(/*@ non_null @*/ JMLCollection<F> c)
        throws ClassCastException
    {
        /*@ non_null @*/ JMLEqualsSequence<F> ret = EMPTY;
    ...
    /*@ // _ alsoIfValue _ //FIXME! later
      ...
      @*/ 
    /*@
    model public E itemAt(\bigint i) throws JMLSequenceException {
        if (i < 0 || i >= this.length) {
            throw new JMLSequenceException("Index out of range.");
        } else {
            JMLListEqualsNode<E> thisWalker = theSeq;
    ...
    model public \bigint bi_count(Object item) {
        JMLListEqualsNode<E> ptr = this.theSeq;
        \bigint cnt = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isPrefix(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isProperPrefix(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is true *);
      @*/
    public boolean isSuffix(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
        ...
        JMLListEqualsNode<E> suffix = s2.theSeq.removePrefix(s2.int_length() - int_length());
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isProperSuffix(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
    ...
    /*@ also
      ...
      @     ensures \result <==>
      @          isPrefix((JMLEqualsSequence<E>)obj)
      @          && ((JMLEqualsSequence<E>)obj).isPrefix(this);
      @     ensures_redundantly \result ==>
      @          containsNull == ((JMLEqualsSequence<E>)obj).containsNull;
      @ also
      @  public normal_behavior
      @    requires obj == null || !(obj instanceof JMLEqualsSequence);
      @    ensures !\result;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object obj) {
        return (obj != null && obj instanceof JMLEqualsSequence)
            && (int_length() == ((JMLEqualsSequence<E>)obj).int_length())
            && isPrefix((JMLEqualsSequence<E>)obj);
    }  
    ...
    /*@ 
      ...
      @     ensures (* \result is b *);
      @*/
    public /*@ pure @*/ E first() throws JMLSequenceException {
        if (theSeq == null) {
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isSubsequence(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
        JMLListEqualsNode<E> walker = s2.theSeq;
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is false *);
      @*/
    public boolean isProperSubsequence(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isSupersequence(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isProperSupersequence(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isInsertionInto(/*@ non_null @*/ JMLEqualsSequence<E> s2,
                                   E elem) {
        if (int_length() != s2.int_length() + 1) {
            return false;
        }
        JMLListEqualsNode<E> walker = theSeq;
        JMLListEqualsNode<E> s2walker = s2.theSeq;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public boolean isDeletionFrom(/*@ non_null @*/ JMLEqualsSequence<E> s2,
                                  E elem) {
    ...
    /*@ also
      ...
      @        && ((JMLEqualsSequence<E>)\result).equals(this);
      @*/
    ...
    /*@ model public JMLEqualsSequence prefix(\bigint n) //FIXME, non_null
        ...
        if (n < 0 || n > length) {
            ...
            if (n == 0) {
                ...
                JMLListEqualsNode<E> pfx_list = theSeq.prefix(n);
                assume pfx_list != null;
                assume !containsNull ==> !pfx_list.containsNull;
                return new JMLEqualsSequence<E>(pfx_list, n);
            }
        }
    }  
    @*/
    ...
    /*@  public normal_behavior
      ...
      @     ensures \result.equals(this);
      @*/
      public /*@ non_null @*/ JMLEqualsSequence<E> prefix(int n)
	  throws JMLSequenceException {
	  if (n < 0 || n > int_length()) {
	      throw new
		  JMLSequenceException("Invalid parameter to prefix() with n = " 
    ...
    /*@
      ...
      @*/
    /*@
      model public JMLEqualsSequence<E> removePrefix(\bigint n) //FIXME,  @non_null@
        throws JMLSequenceException {
        if (n < 0 || n > length) {
            throw new
            ...
            if (n == 0) {
                ...
                JMLListEqualsNode<E> pfx_list = theSeq.removePrefix(n);
    ...
    /*@
      ...
      @     ensures \result.isEmpty();
      @*/
    public /*@ non_null @*/ JMLEqualsSequence<E> removePrefix(int n)
        throws JMLSequenceException {
        if (n < 0 || n > int_length()) {
            throw new
                JMLSequenceException("Invalid parameter to removePrefix() "
            ...
            if (n == 0) {
                ...
                /*@ assume pfx_list == null <==> n == length;
                  ...
                  @*/
                return new JMLEqualsSequence<E>(pfx_list, int_length()-n);
            }
        }
    }  
    ...
    /*@
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSequence<E> concat(/*@ non_null @*/ JMLEqualsSequence<E> s2) {
        if (theSeq == null) {
            return s2;
        } else if (s2.theSeq == null) {
            return this;
        } else {
            JMLListEqualsNode<E> new_list = theSeq.concat(s2.theSeq);
            /*@ assume new_list != null && int_length() + s2.int_length() > 0;
              @*/
            return new JMLEqualsSequence<E>(new_list,
                                         int_length() + s2.int_length());
        }
    }  //@ nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @    ensures containsNull <==> \result.containsNull;
      @*/
    public /*@ non_null @*/ JMLEqualsSequence<E> reverse() {
        if (theSeq == null) {
            return this;
        } else {
            JMLListEqualsNode<E> r = theSeq.reverse();
            return new JMLEqualsSequence<E>(r, int_length());
        }
    } //@ nowarn Post;
    ...
    model public  non_null  JMLEqualsSequence removeItemAt(\bigint index)
        ...
        if (0 <= index && index < length()) {
            JMLListEqualsNode<E> new_list = theSeq.removeItemAt(index);
             assume new_list == null <==> int_length() == 1;
             assume !containsNull && new_list != null
                ==> !new_list.containsNull;
            
            return new JMLEqualsSequence<E>(new_list, length()-1);
        } else {
            throw new
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is <a,b,c,d> *);
      @*/
    public /*@ non_null @*/ JMLEqualsSequence<E> removeItemAt(int index)
        throws JMLSequenceException {
        if (0 <= index && index < int_length()) {
            ...
            /*@ assume new_list == null <==> int_length() == 1;
              ...
              @    ==> !new_list.containsNull;
              @*/
            return new JMLEqualsSequence<E>(new_list, int_length()-1);
        } else {
            throw new
                JMLSequenceException("Invalid parameter to removeItemAt() "
                                     + "with index = " + index + "\n"
    ...
    /*@
      ...
      @*/
    /*@
    model public  non_null  JMLEqualsSequence<E>
        replaceItemAt(\bigint index, Object item)
        throws JMLSequenceException {
        if (0 <= index && index < length()) {
            // replaceItemAt() clones item, if necessary
            JMLListEqualsNode<E> new_list = theSeq.replaceItemAt(index, item);
             assume new_list == null <==> length() == 0;
            return new JMLEqualsSequence<E>(new_list, length());
        } else {
            throw new
    ...
    /*@
      ...
      @     ensures (* \result is <a,x,c,d,e> *);
      @*/
    public /*@ non_null @*/ JMLEqualsSequence<E> replaceItemAt(int index, E item)
        throws JMLSequenceException {
        if (0 <= index && index < int_length()) {
            // replaceItemAt() clones item, if necessary
            JMLListEqualsNode<E> new_list = theSeq.replaceItemAt(index, item);
            //@ assume new_list == null <==> int_length() == 0;
            return new JMLEqualsSequence<E>(new_list, int_length());
        } else {
            throw new
                JMLSequenceException("Invalid parameter to replaceItemAt() "
                                     + "with index = " + index + "\n"
    ...
    /*@  public normal_behavior
      ...
      @     ensures (* \result is <a,b,c> *);
      @*/
    public /*@ non_null @*/ JMLEqualsSequence<E> header()
        throws JMLSequenceException {
        if (theSeq == null) {
            throw new JMLSequenceException("Tried header() on empty sequence.");
        } else {
            JMLListEqualsNode<E> new_list = theSeq.removeLast();
            //@ assume new_list == null <==> int_length() == 1;
            return new JMLEqualsSequence<E>(new_list, int_length() - 1);
        }   
    } //@ nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ /*@ non_null @*/ JMLEqualsSequence<E> trailer()
        throws JMLSequenceException {
        if (theSeq == null) {
            throw new JMLSequenceException("Tried trailer() on empty sequence.");
        } else {
            JMLListEqualsNode<E> new_list = theSeq.next;
            //@ assume new_list == null <==> int_length() == 1;
    ...
    /*@ //FIXME, _ alsoIfValue _
      ...
      @*/
    /*@
    model public non_null JMLEqualsSequence<E> insertAfterIndex(\bigint afterThisOne,
                                                             E item) //FIXME, _ nonNullIfObj _ 
    ...
    /*@ 
      ...
      @     ensures (* \result is <d,a,b,c> *);
      @*/
    public /*@ non_null @*/ JMLEqualsSequence<E> insertAfterIndex(int afterThisOne,
                                                             E item)
        throws JMLSequenceException, IllegalStateException
    {
    ...
    /*@ //FIXME, _ alsoIfValue _
      ...
      @                  concat(new JMLEqualsSequence<E>(item)).
    ...
    /*@ 
      model public  
        non_null JMLEqualsSequence<E> insertBeforeIndex(\bigint beforeThisOne, E item)
        throws JMLSequenceException, IllegalStateException //FIXME, _ nonNullIfObj _
    {
	  ...
	  return new JMLEqualsSequence<E>(item);
	} else {
	  // insertBefore() clones item, if necessary
	  JMLListEqualsNode<E> new_list
    ...
    /*@ 
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSequence<E> insertBeforeIndex(int beforeThisOne, E item)
        throws JMLSequenceException, IllegalStateException
    {
    ...
    /*@ 
      ...
      @     ensures (* \result is <a,b,c,d> *);
      @*/
    public /*@ non_null @*/ JMLEqualsSequence<E> insertBack(E item)
        throws IllegalStateException
    {
        if (theSeq == null) {
            ...
            return new JMLEqualsSequence<E>(theSeq.append(item), int_length()+1);
        } else {
            throw new IllegalStateException(TOO_BIG_TO_INSERT);
        }
    }
    ...
    /*@ 
      ...
      @     ensures (* \result is <d,a,b,c> *);
      @*/
    public /*@ pure @*/ /*@ non_null @*/ JMLEqualsSequence<E> insertFront(E item)
        throws IllegalStateException
    {
        if (theSeq == null) {
            return new JMLEqualsSequence<E>(item);
        } else if (int_length() < Integer.MAX_VALUE) {
            return new JMLEqualsSequence<E>(  // cons() clones item, if necessary
    ...
    /*@  public normal_behavior
      ...
      @*/
    /*@
    model public  non_null  JMLEqualsSequence<E> subsequence(\bigint from, \bigint to)
        throws JMLSequenceException {
        if (from < 0 || from > to || to > length()) {
            ...
            if (theSeq == null) {
                ...
                JMLListEqualsNode<E> removedPrefix = theSeq.removePrefix(from);
                if (removedPrefix == null) {
                     assert from == length() && from == to;
                    return new JMLEqualsSequence<E>();
                } else {
                    JMLListEqualsNode<E> new_list = removedPrefix.prefix(to-from);
                     assume new_list == null <==> to == from;
                    return new JMLEqualsSequence<E>(new_list, to - from);
                }
            }
        }
    }  nowarn Post;
    ...
    /*@  public normal_behavior
      ...
      @     ensures \result.isEmpty();
      @*/
    public /*@ non_null @*/ JMLEqualsSequence<E> subsequence(int from, int to)
        throws JMLSequenceException {
    ...
    /** Return a new JMLEqualsBag<E> containing all the elements of this.
     * @see #toSet()
     * @see #toArray()
     */
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsBag<E> toBag() {
        JMLEqualsBag<E> ret = new JMLEqualsBag<E>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsSequenceEnumerator<E> elements() {
        JMLEqualsSequenceEnumerator<E> retValue 
            = new JMLEqualsSequenceEnumerator<E>(this);
        return retValue;
    }  
    ...
    public /*@ non_null @*/ String toString() {
        String newStr = "(<";
        JMLListEqualsNode<E> seqWalker = theSeq;
        boolean first = true;
