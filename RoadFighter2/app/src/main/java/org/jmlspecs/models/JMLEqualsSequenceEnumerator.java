...
/*@ nullable_by_default @*/ 
public class JMLEqualsSequenceEnumerator<E>
    implements JMLEnumeration<E>, JMLObjectType
{

    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLEqualsSequence<E> uniteratedElems; in objectState;
    ...
    /*@ protected represents uniteratedElems
      @                  <- new JMLEqualsSequence<E>(currentNode, remaining);
      @*/
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLEqualsSequenceEnumerator(/*@ non_null @*/ JMLEqualsSequence<E> s) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return
            new JMLEqualsSequenceEnumerator<E>(new JMLEqualsSequence<E>(currentNode,
                                                                  remaining));
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLEqualsSequenceEnumerator)) {
            ...
            JMLEqualsSequenceEnumerator<E> js
                = (JMLEqualsSequenceEnumerator<E>) oth;
            if (currentNode == null) {
