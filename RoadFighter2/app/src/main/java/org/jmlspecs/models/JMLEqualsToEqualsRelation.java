 ...
 */
//-@ immutable
public /*@ pure @*/ class JMLEqualsToEqualsRelation<K, V>
    implements JMLCollection<JMLEqualsEqualsPair<K, V>> {

    /** The set of pairs of keys and values conceptually contained in
     * this object.
     */
    //@ public model JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>> theRelation;
    /*@ public invariant
     ...
     */
    protected final /*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> imagePairSet_;
    //@                                             in theRelation;
    ...
    /*@  public normal_behavior
      ...
      @    ensures theRelation.equals(new JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>>());
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLEqualsToEqualsRelation(/*@ non_null @*/ K dv,
                                        /*@ non_null @*/ V rv)
    {
        //@ set owner = null;
        //@ set containsNull = false;
     ...
     * @see #JMLEqualsToEqualsRelation(K, V)
     */
    /*@  public normal_behavior
      @    requires pair != null;
      @    assignable theRelation, owner, elementType, containsNull;
    ...
    /*@  protected normal_behavior
      ...
      @*/
    protected
        JMLEqualsToEqualsRelation(/*@ non_null @*/ JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> ipset, 
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToEqualsRelation<SK, SR>(dv, rv));
      @*/
    public static <SK, SR> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToEqualsRelation<SK, SR>
    ...
    public static <SK, SR> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToEqualsRelation<SK, SR>
        singleton(/*@ non_null @*/ JMLEqualsEqualsPair<SK, SR> pair)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet<V> image(/*@ non_null @*/ JMLEqualsSet<K> dom)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsToEqualsRelation<V, K> inverse()
    {
        JMLEqualsToEqualsRelation<V, K> invRel
            = new JMLEqualsToEqualsRelation<V, K>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet<K> inverseImage(/*@ non_null @*/ JMLEqualsSet<V> rng)
    {
        JMLEqualsSet<K> invImg = new JMLEqualsSet<K>();
        JMLEqualsToEqualsRelationImageEnumerator<K, V> imagePairEnum
            = this.imagePairs();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(/*@ non_null @*/ JMLEqualsEqualsPair<K, V> pair)
    {
    ...
    /*@ also
      ...
      @              obj != null
      @           && obj instanceof JMLEqualsEqualsPair
      @           && has((JMLEqualsEqualsPair<K, V>) obj);
      @*/
    ...
    {
        return new
            JMLEqualsToEqualsRelation<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
    ...
    public boolean equals(/*@ nullable @*/ Object obj)
    {
        ...
        JMLEqualsToEqualsRelation<K, V> rel
            = (JMLEqualsToEqualsRelation<K, V>) obj;
    ...
    public /*@ pure @*/ /*@ non_null @*/ 
        JMLEqualsToEqualsRelation<K, V> add(/*@ non_null @*/ K dv,
                                         /*@ non_null @*/ V rv)
        throws NullPointerException, IllegalStateException
    {
        ...
        if (!domain_.has(dv)) {
            ...
            newImagePairSet
                = imagePairSet_.insert(new JMLEqualsValuePair<K, JMLEqualsSet<V>>(dv, img));
        } else {
            ...
            while (imagePairEnum.hasMoreElements()) {
                ...
                newImagePairSet 
                    = newImagePairSet
                    .insert(new JMLEqualsValuePair<K, JMLEqualsSet<V>>(imagePair.key, img));
            }
        }
        return new JMLEqualsToEqualsRelation<K, V>(newImagePairSet,
                                                newDom, newSize);
    }
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation<K, V> insert(/*@ non_null @*/
                                         JMLEqualsEqualsPair<K, V> pair)
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation<K, V> removeFromDomain(/*@ nullable @*/ K dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> newImagePairSet
				= new JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>>();
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation<K, V> remove(K dv, V rv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
        ...
        while (imagePairEnum.hasMoreElements()) {
            ...
            if (imagePair.keyEquals(dv)) {
                ...
                if (imgSize > 0) {
                    newImagePairSet
                        = newImagePairSet
                        .insert(new JMLEqualsValuePair<K, JMLEqualsSet<V>>(dv, img));
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation<K, V> remove(/*@ non_null @*/
                                            JMLEqualsEqualsPair<K, V> pair)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation<K, V> 
        union(/*@ non_null @*/ JMLEqualsToEqualsRelation<K, V> othRel)
        throws IllegalStateException
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>>();
        JMLEqualsSet<K> newDom = domain_;
        ...
        return new JMLEqualsToEqualsRelation<K, V>(newImagePairSet, newDom,
                                                newSize);
    }
    ...
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation<K, V>
        intersection(/*@ non_null @*/ JMLEqualsToEqualsRelation<K, V> othRel)
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>>();
    ...
    public /*@ non_null @*/  
        JMLEqualsToEqualsRelation<K, V>
        difference(/*@ non_null @*/ JMLEqualsToEqualsRelation<K, V> othRel)
    {
        JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>> newImagePairSet = new JMLValueSet<JMLEqualsValuePair<K, JMLEqualsSet<V>>>();
        JMLEqualsSet<K> newDom = new JMLEqualsSet<K>();
        int newSize = 0;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToEqualsRelationEnumerator<K, V> elements()
    {
        return associations();
    }
    ...
    /*@ public normal_behavior
      ...
      @             
      @*/
    public /*@ non_null @*/ JMLValueSet<JMLEqualsEqualsPair<K, V>> toSet() {
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueBag<JMLEqualsEqualsPair<K, V>> toBag() {
        JMLEqualsToEqualsRelationEnumerator<K, V> pairEnum = this.associations();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLValueSequence<JMLEqualsEqualsPair<K, V>> toSequence() {
        JMLEqualsToEqualsRelationEnumerator<K, V> pairEnum = this.associations();
    ...
    /*@ public normal_behavior
      ...
      @                \result.has(
      @                    new JMLEqualsValuePair<K, JMLEqualsSet<V>>(dv, elementImage(dv))));
      @*/
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsToEqualsMap<K, V> toFunction()
    {
        JMLEqualsSet<K> newDom = domain_;
