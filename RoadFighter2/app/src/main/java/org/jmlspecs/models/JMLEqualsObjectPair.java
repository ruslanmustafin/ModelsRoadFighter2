...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLEqualsObjectPair<K, V> implements JMLType {
     ...
     */
    public /*@ extract @*/ JMLEqualsObjectPair(/*@ non_null @*/ K dv,
                               /*@ non_null @*/ V rv)
    ...
    {
        return new JMLEqualsObjectPair<K, V>(key, value);
    } //@ nowarn Post;
