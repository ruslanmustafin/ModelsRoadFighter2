...
/*@ nullable_by_default @*/ 
class JMLEqualsToValueMap<K, V extends JMLType> extends JMLEqualsToValueRelation<K, V> {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLEqualsToValueMap(/*@ non_null @*/ K dv,
                                   /*@ non_null @*/ V rv)
    {
        super(dv, rv);
    }
    ...
    protected JMLEqualsToValueMap(JMLValueSet<JMLEqualsValuePair<K, JMLValueSet<V>>> ipset,
                                      JMLEqualsSet<K> dom,
                                      int sz)
    {
        super(ipset, dom, sz);
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToValueMap<K, V>(dv, rv));
      @*/
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToValueMap<SK, SR>
        singletonMap(/*@ non_null @*/ SK dv,
                     /*@ non_null @*/ SR rv)
    {
        return new JMLEqualsToValueMap<SK, SR>(dv, rv);
    }
    ...
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToValueMap<SK, SR>
        singletonMap(/*@ non_null @*/ JMLEqualsValuePair<SK, SR> pair)
    {
        return new JMLEqualsToValueMap<SK, SR>(pair);
    }
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLEqualsToValueMap<K, V>
      @          && ((JMLEqualsToValueMap<K, V>)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLEqualsToValueMap<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
     ...
     * @see JMLEqualsToValueRelation#insert(K, V)
     */
    /*@  public normal_behavior
      @    requires dv != null && rv != null;
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToValueMap<K, V> extend(/*@ non_null @*/ K dv,
                                       /*@ non_null @*/ V rv) 
    {
        JMLEqualsToValueMap<K, V> newMap = this.removeDomainElement(dv);
        newMap = newMap.disjointUnion(new JMLEqualsToValueMap<K, V>(dv, rv));
        return newMap;
    } //@ nowarn Exception;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToValueMap<K, V> removeDomainElement(K dv)
    {
    ...
    public /*@ non_null @*/ <D extends JMLType>
        ...
        compose(/*@ non_null @*/ JMLValueToEqualsMap<D, K> othMap)
    {
    ...
    public /*@ non_null @*/ <D>
        ...
        compose(/*@ non_null @*/ JMLObjectToEqualsMap<D, K> othMap)
    {
        return super.compose(othMap).toFunction();
    }
    ...
    /*@  public normal_behavior
      @    requires dom != null;
      @    ensures (\forall JMLEqualsValuePair<K, V> pair; ; 
      @                 \result.theRelation.has(pair)
      @                    == 
      @                       dom.has(pair.key) 
      @                    && elementImage(pair.key).has(pair.value)
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToValueMap<K, V> 
        restrictedTo(/*@ non_null @*/ JMLEqualsSet<K> dom) 
    {
    ...
    public /*@ non_null @*/ 
        JMLEqualsToValueMap<K, V>
        extendUnion(/*@ non_null @*/ JMLEqualsToValueMap<K, V> othMap) 
        throws IllegalStateException
    {
        JMLEqualsToValueMap<K, V> newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLEqualsToValueMap<K, V>(newMap.imagePairSet_
    ...
    public /*@ non_null @*/ 
        JMLEqualsToValueMap<K, V>
        clashReplaceUnion(JMLEqualsToValueMap<K, V> othMap,
                          V errval)
        throws IllegalStateException
    {
        JMLEqualsSet<K> overlap = this.domain_.intersection(othMap.domain_);
        ...
        JMLEqualsToValueRelation<K, V> newRel;
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLEqualsToValueRelation<K, V>(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLEqualsToValueMap<K, V> 
        disjointUnion(/*@ non_null @*/ JMLEqualsToValueMap<K, V> othMap) 
        throws JMLMapException, IllegalStateException
    {
        JMLEqualsSet<K> overlappingDom = domain_.intersection(othMap.domain_);
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLEqualsToValueMap<K, V>(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
