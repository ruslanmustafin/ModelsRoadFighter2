...
/*@ nullable_by_default @*/ 
class JMLEqualsToObjectMap<K, V> extends JMLEqualsToObjectRelation<K, V> {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public JMLEqualsToObjectMap(/*@ non_null @*/ K dv,
                                   /*@ non_null @*/ V rv)
    {
        super(dv, rv);
    }
    ...
    protected JMLEqualsToObjectMap(JMLValueSet<JMLEqualsValuePair<K, JMLObjectSet<V>>> ipset,
                                      JMLEqualsSet<K> dom,
                                      int sz)
    {
        super(ipset, dom, sz);
    ...
    /*@ public normal_behavior
      @    requires dv != null && rv != null;
      @    ensures \result != null
      @         && \result.equals(new JMLEqualsToObjectMap<K, V>(dv, rv));
      @*/
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToObjectMap<SK, SR>
        singletonMap(/*@ non_null @*/ SK dv,
                     /*@ non_null @*/ SR rv)
    {
        return new JMLEqualsToObjectMap<SK, SR>(dv, rv);
    }
    ...
    public static <SK, SR extends JMLType> /*@ pure @*/ /*@ non_null @*/
        JMLEqualsToObjectMap<SK, SR>
        singletonMap(/*@ non_null @*/ JMLEqualsObjectPair<SK, SR> pair)
    {
        return new JMLEqualsToObjectMap<SK, SR>(pair);
    }
    ...
    /*@ also
      @   public normal_behavior
      @     ensures \result instanceof JMLEqualsToObjectMap<K, V>
      @          && ((JMLEqualsToObjectMap<K, V>)\result)
      @                .theRelation.equals(this.theRelation);
      @*/
    //@ pure
    public /*@ non_null @*/ Object clone() 
    {
        return new JMLEqualsToObjectMap<K, V>(imagePairSet_, domain_, size_);
    } //@ nowarn Post;
     ...
     * @see JMLEqualsToObjectRelation#insert(K, V)
     */
    /*@  public normal_behavior
      @    requires dv != null && rv != null;
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToObjectMap<K, V> extend(/*@ non_null @*/ K dv,
                                       /*@ non_null @*/ V rv) 
    {
        JMLEqualsToObjectMap<K, V> newMap = this.removeDomainElement(dv);
        newMap = newMap.disjointUnion(new JMLEqualsToObjectMap<K, V>(dv, rv));
        return newMap;
    } //@ nowarn Exception;
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsToObjectMap<K, V> removeDomainElement(K dv)
    {
    ...
    /*@  public normal_behavior
      @    requires dom != null;
      @    ensures (\forall JMLEqualsObjectPair<K, V> pair; ; 
      @                 \result.theRelation.has(pair)
      @                    == 
      @                       dom.has(pair.key) 
      @                    && elementImage(pair.key).has(pair.value)
    ...
    public /*@ non_null @*/ 
        JMLEqualsToObjectMap<K, V>
        extendUnion(/*@ non_null @*/ JMLEqualsToObjectMap<K, V> othMap) 
        throws IllegalStateException
    {
        JMLEqualsToObjectMap<K, V> newMap 
            = this.restrictedTo(this.domain_.difference(othMap.domain_));
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            return
                new JMLEqualsToObjectMap<K, V>(newMap.imagePairSet_
    ...
    public /*@ non_null @*/ 
        JMLEqualsToObjectMap<K, V>
        clashReplaceUnion(JMLEqualsToObjectMap<K, V> othMap,
                          V errval)
        throws IllegalStateException
    {
        ...
        JMLEqualsToObjectRelation<K, V> newRel;
        if (newMap.size_ <= Integer.MAX_VALUE - othMap.size_) {
            newRel = new JMLEqualsToObjectRelation<K, V>(newMap.imagePairSet_
                                                      .union(othMap
                                                             .imagePairSet_),
                                                      newMap.domain_
                                                      .union(othMap.domain_),
    ...
    public /*@ non_null @*/ 
        JMLEqualsToObjectMap<K, V> 
        disjointUnion(/*@ non_null @*/ JMLEqualsToObjectMap<K, V> othMap) 
        throws JMLMapException, IllegalStateException
    {
        ...
        if (overlappingDom.isEmpty()) {
            if (this.size_ <= Integer.MAX_VALUE - othMap.size_) {
                return new JMLEqualsToObjectMap<K, V>(this.imagePairSet_
                                                   .union(othMap
                                                          .imagePairSet_),
                                                   this.domain_
                                                   .union(othMap.domain_),
