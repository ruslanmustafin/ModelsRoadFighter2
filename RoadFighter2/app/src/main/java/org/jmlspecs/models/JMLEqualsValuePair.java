...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ class JMLEqualsValuePair<K, V extends JMLType> implements JMLType {
     ...
     */
    public /*@ extract @*/ JMLEqualsValuePair(/*@ non_null @*/ K dv,
                               /*@ non_null @*/ V rv)
    ...
    {
        return new JMLEqualsValuePair<K, V>(key, value);
    } //@ nowarn Post;
