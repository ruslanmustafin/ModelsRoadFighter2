...
/*@ nullable_by_default @*/ 
public class JMLEqualsBagEnumerator<E>
    implements JMLEnumeration<E>, JMLObjectType
{
    /** The elements that have not yet been returned by nextElement.
     */
    //@ public model JMLEqualsBag<E> uniteratedElems;   in objectState;

    /** The bag underlying this enumerator.
     */
    protected /*@ non_null @*/ JMLEqualsBag<E> currentBag;
    //@                                        in uniteratedElems;
    ...
    /*@ normal_behavior
      ...
      @*/
    JMLEqualsBagEnumerator(/*@ non_null @*/ JMLEqualsBag<E> b) {
        //@ set owner = null;
    ...
    public /*@ non_null @*/ Object clone() {
        return new JMLEqualsBagEnumerator<E>(abstractValue());
    } //@ nowarn Post;

    /** Return the abstract value of this bag enumerator.
     */
    protected /*@ pure non_null @*/ JMLEqualsBag<E> abstractValue() {
        JMLEqualsBag<E> absVal = currentBag;
        if (currentCount > 0) {
    ...
    public boolean equals(/*@ nullable @*/ Object oth) {
        if  (oth == null || !(oth instanceof JMLEqualsBagEnumerator)) {
            ...
            JMLEqualsBagEnumerator<E> jb = (JMLEqualsBagEnumerator<E>) oth;
